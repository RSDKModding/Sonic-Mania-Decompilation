...
void PimPom_EditorLoad(void)
{
    ...
    RSDK_ENUM_VAR(PIMPOM_SINGLE);
    RSDK_ENUM_VAR(PIMPOM_HORIZONTAL);
    RSDK_ENUM_VAR(PIMPOM_DIAGONAL);
    RSDK_ENUM_VAR(PIMPOM_VERTICAL);

    RSDK_ACTIVE_VAR(PimPom, moveType);
    RSDK_ENUM_VAR(PIMPOM_MOVE_NONE);
    RSDK_ENUM_VAR(PIMPOM_MOVE_NORMAL);
    RSDK_ENUM_VAR(PIMPOM_MOVE_CIRCLE);
    RSDK_ENUM_VAR(PIMPOM_MOVE_3);
    RSDK_ENUM_VAR(PIMPOM_MOVE_4);
}
#endif
