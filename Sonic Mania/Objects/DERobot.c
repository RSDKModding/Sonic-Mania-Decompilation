...
void DERobot_Unknown34(void)
{
    ...
    if (entity->parts[5]->onGround) {
        ...
        EntityEggman *eggman = (EntityEggman *)entity->parts[2];
        RSDK.SetSpriteAnimation(Eggman->spriteIndex, 2, &eggman->data, true, 0);
...
void DERobot_Unknown35(void)
{
    ...
    if (part1->angle <= 0) {
        ...
        RSDK.SetSpriteAnimation(Eggman->spriteIndex, 3, &eggman->data, true, 0);
        eggman->state                              = Eggman_Unknown2;
...
void DERobot_Unknown38(void)
{
    ...
    if (++entity->timer == 90) {
        ...
        EntityEggman *eggman = (EntityEggman *)entity->parts[2];
        RSDK.SetSpriteAnimation(Eggman->spriteIndex, 4, &eggman->data, true, 0);
        entity->timer      = 0;
        entity->offset.x   = 0;
