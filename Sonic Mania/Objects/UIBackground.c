...
{
    EntityUIBackground *entity = (EntityUIBackground *)RSDK_sceneInfo->entity;
    if (entity->state)
        entity->state();
}
...
void UIBackground_DrawNormal()
{
    ...
    RSDK.DrawCircle(drawPos.x + RSDK_screens->centerX, drawPos.y + RSDK_screens->centerY, 26, colourPtrs[1], 255, INK_NONE, true);
