...
void UIKeyBinder_DrawSprites(void)
{
    ...
    UIWidgets_Unknown7(self->field_114 >> 16, self->field_110 >> 16, self->field_118, 0xF0, 0xF0, 0xF0, drawPos.x, drawPos.y);

    drawPos.x += self->field_120;
    drawPos.y += self->field_120;
    drawPos.x += self->field_120;
    drawPos.y += self->field_120;
    UIWidgets_Unknown7(self->field_114 >> 16, self->field_110 >> 16, self->field_118, 0, 0, 0, drawPos.x, drawPos.y);
