...
void UIBackground_DrawNormal(void)
{
    ...
    RSDK.DrawCircleOutline(ScreenInfo->centerX, ScreenInfo->centerY, (RSDK.Sin512(entity->timer) >> 3) + 108,
    ...
    RSDK.DrawCircleOutline(ScreenInfo->centerX, ScreenInfo->centerY, (RSDK.Cos512(entity->timer) >> 3) + 140,
