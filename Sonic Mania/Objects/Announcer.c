...
{
    EntityAnnouncer *entity = (EntityAnnouncer *)RSDK_sceneInfo->entity;
    if (entity->state)
        entity->state();
}
...
void Announcer_Unknown7()
{
    ...
    if (entity->timer >= 150) {
        switch (entity->playerID) {
            case 0:
                RSDK.PlaySFX(Announcer->sfx_Player1, 0, 255);
                break;
            case 1:
                RSDK.PlaySFX(Announcer->sfx_Player2, 0, 255);
                break;
            case 2:
                RSDK.PlaySFX(Announcer->sfx_Player3, 0, 255);
                break;
            case 3:
                RSDK.PlaySFX(Announcer->sfx_Player4, 0, 255);
                break;
            default: break;
        }
        RSDK.ResetEntityPtr(entity, 0, 0);
...
void Announcer_Unknown9()
{
    ...
    if (entity->timer >= 30) {
        switch (entity->playerID) {
            case ID_SONIC:
                RSDK.PlaySFX(Announcer->sfx_SonicWins, 0, 255);
                break;
            case ID_TAILS:
                RSDK.PlaySFX(Announcer->sfx_TailsWins, 0, 255);
                break;
            case ID_KNUCKLES:
                RSDK.PlaySFX(Announcer->sfx_KnuxWins, 0, 255);
                break;
            case ID_MIGHTY:
                RSDK.PlaySFX(Announcer->sfx_MightyWins, 0, 255);
                break;
            case ID_RAY:
                RSDK.PlaySFX(Announcer->sfx_RayWins, 0, 255);
                break;
            default: break;
        }
        RSDK.ResetEntityPtr(entity, 0, 0);
