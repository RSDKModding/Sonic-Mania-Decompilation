...
This repo includes everything you need for Sonic Mania + RSDKv5. If you wish to compile only Sonic Mania, you can skip to the [compilation steps below](#compiling).
