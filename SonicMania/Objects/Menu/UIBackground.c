...
void UIBackground_DrawNormal(void)
{
    ...
    RSDK.DrawCircleOutline(ScreenInfo->centerX, ScreenInfo->centerY, (RSDK.Sin512(self->timer) >> 3) + 108, (RSDK.Sin512(self->timer) >> 3) + 116,
                           colorPtrs[1], 0xFF, INK_NONE, true);

    RSDK.DrawCircle(drawPos.x + ScreenInfo->centerX, drawPos.y + ScreenInfo->centerY, 32, colorPtrs[1], 0xFF, INK_NONE, true);
    RSDK.DrawCircle(ScreenInfo->centerX - drawPos.x, ScreenInfo->centerY - drawPos.y, 16, colorPtrs[1], 0xFF, INK_NONE, true);
    RSDK.DrawCircle(drawPos.x + ScreenInfo->centerX, drawPos.y + ScreenInfo->centerY, 26, colorPtrs[0], 0xFF, INK_NONE, true);
    ...
    RSDK.DrawCircleOutline(ScreenInfo->centerX, ScreenInfo->centerY, (RSDK.Cos512(self->timer) >> 3) + 140, (RSDK.Cos512(self->timer) >> 3) + 148,
                           colorPtrs[2], 0xFF, INK_NONE, true);

    RSDK.DrawCircle(drawPos.x + ScreenInfo->centerX, drawPos.y + ScreenInfo->centerY, 32, colorPtrs[2], 0xFF, INK_NONE, true);
    RSDK.DrawCircle(ScreenInfo->centerX - drawPos.x, ScreenInfo->centerY - drawPos.y, 16, colorPtrs[2], 0xFF, INK_NONE, true);
    RSDK.DrawCircle(drawPos.x + ScreenInfo->centerX, drawPos.y + ScreenInfo->centerY, 26, colorPtrs[0], 0xFF, INK_NONE, true);
}
