...
void linkGameLogic(void *gameInfo)
{
    ...
    CreateObject(&AIZEncoreTutorial, "AIZEncoreTutorial", sizeof(EntityAIZEncoreTutorial), sizeof(ObjectAIZEncoreTutorial), AIZEncoreTutorial_Update,
    ...
    CreateObject(&AIZKingClaw, "AIZKingClaw", sizeof(EntityAIZKingClaw), sizeof(ObjectAIZKingClaw), AIZKingClaw_Update, AIZKingClaw_LateUpdate,
    ...
    CreateObject(&AIZRockPile, "AIZRockPile", sizeof(EntityAIZRockPile), sizeof(ObjectAIZRockPile), AIZRockPile_Update, AIZRockPile_LateUpdate,
    ...
    CreateObject(&AIZSetup, "AIZSetup", sizeof(EntityAIZSetup), sizeof(ObjectAIZSetup), AIZSetup_Update, AIZSetup_LateUpdate, AIZSetup_StaticUpdate,
                 AIZSetup_Draw, AIZSetup_Create, AIZSetup_StageLoad, AIZSetup_EditorDraw, AIZSetup_EditorLoad, AIZSetup_Serialize);
    CreateObject(&AIZTornado, "AIZTornado", sizeof(EntityAIZTornado), sizeof(ObjectAIZTornado), AIZTornado_Update, AIZTornado_LateUpdate,
    ...
    CreateObject(&AIZTornadoPath, "AIZTornadoPath", sizeof(EntityAIZTornadoPath), sizeof(ObjectAIZTornadoPath), AIZTornadoPath_Update,
    ...
    CreateObject(&AmoebaDroid, "AmoebaDroid", sizeof(EntityAmoebaDroid), sizeof(ObjectAmoebaDroid), AmoebaDroid_Update, AmoebaDroid_LateUpdate,
    ...
    CreateObject(&AnimalHBH, "AnimalHBH", sizeof(EntityAnimalHBH), sizeof(ObjectAnimalHBH), AnimalHBH_Update, AnimalHBH_LateUpdate,
                 AnimalHBH_StaticUpdate, AnimalHBH_Draw, AnimalHBH_Create, AnimalHBH_StageLoad, AnimalHBH_EditorDraw, AnimalHBH_EditorLoad,
                 AnimalHBH_Serialize);
    CreateObject(&Animals, "Animals", sizeof(EntityAnimals), sizeof(ObjectAnimals), Animals_Update, Animals_LateUpdate, Animals_StaticUpdate,
                 Animals_Draw, Animals_Create, Animals_StageLoad, Animals_EditorDraw, Animals_EditorLoad, Animals_Serialize);
    CreateObject(&Announcer, "Announcer", sizeof(EntityAnnouncer), sizeof(ObjectAnnouncer), Announcer_Update, Announcer_LateUpdate,
                 Announcer_StaticUpdate, Announcer_Draw, Announcer_Create, Announcer_StageLoad, Announcer_EditorDraw, Announcer_EditorLoad,
                 Announcer_Serialize);
    CreateObject(&Aquis, "Aquis", sizeof(EntityAquis), sizeof(ObjectAquis), Aquis_Update, Aquis_LateUpdate, Aquis_StaticUpdate, Aquis_Draw,
                 Aquis_Create, Aquis_StageLoad, Aquis_EditorDraw, Aquis_EditorLoad, Aquis_Serialize);
    CreateObject(&Armadiloid, "Armadiloid", sizeof(EntityArmadiloid), sizeof(ObjectArmadiloid), Armadiloid_Update, Armadiloid_LateUpdate,
    ...
    CreateObject(&BallCannon, "BallCannon", sizeof(EntityBallCannon), sizeof(ObjectBallCannon), BallCannon_Update, BallCannon_LateUpdate,
    ...
    CreateObject(&BallHog, "BallHog", sizeof(EntityBallHog), sizeof(ObjectBallHog), BallHog_Update, BallHog_LateUpdate, BallHog_StaticUpdate,
                 BallHog_Draw, BallHog_Create, BallHog_StageLoad, BallHog_EditorDraw, BallHog_EditorLoad, BallHog_Serialize);
    CreateObject(&BarStool, "BarStool", sizeof(EntityBarStool), sizeof(ObjectBarStool), BarStool_Update, BarStool_LateUpdate, BarStool_StaticUpdate,
                 BarStool_Draw, BarStool_Create, BarStool_StageLoad, BarStool_EditorDraw, BarStool_EditorLoad, BarStool_Serialize);
    CreateObject(&Batbrain, "Batbrain", sizeof(EntityBatbrain), sizeof(ObjectBatbrain), Batbrain_Update, Batbrain_LateUpdate, Batbrain_StaticUpdate,
                 Batbrain_Draw, Batbrain_Create, Batbrain_StageLoad, Batbrain_EditorDraw, Batbrain_EditorLoad, Batbrain_Serialize);
    CreateObject(&Beanstalk, "Beanstalk", sizeof(EntityBeanstalk), sizeof(ObjectBeanstalk), Beanstalk_Update, Beanstalk_LateUpdate,
                 Beanstalk_StaticUpdate, Beanstalk_Draw, Beanstalk_Create, Beanstalk_StageLoad, Beanstalk_EditorDraw, Beanstalk_EditorLoad,
                 Beanstalk_Serialize);
    CreateObject(&BGSwitch, "BGSwitch", sizeof(EntityBGSwitch), sizeof(ObjectBGSwitch), BGSwitch_Update, BGSwitch_LateUpdate, BGSwitch_StaticUpdate,
                 BGSwitch_Draw, BGSwitch_Create, BGSwitch_StageLoad, BGSwitch_EditorDraw, BGSwitch_EditorLoad, BGSwitch_Serialize);
    CreateObject(&BigSqueeze, "BigSqueeze", sizeof(EntityBigSqueeze), sizeof(ObjectBigSqueeze), BigSqueeze_Update, BigSqueeze_LateUpdate,
    ...
    CreateObject(&BladePole, "BladePole", sizeof(EntityBladePole), sizeof(ObjectBladePole), BladePole_Update, BladePole_LateUpdate,
                 BladePole_StaticUpdate, BladePole_Draw, BladePole_Create, BladePole_StageLoad, BladePole_EditorDraw, BladePole_EditorLoad,
                 BladePole_Serialize);
    CreateObject(&Blaster, "Blaster", sizeof(EntityBlaster), sizeof(ObjectBlaster), Blaster_Update, Blaster_LateUpdate, Blaster_StaticUpdate,
                 Blaster_Draw, Blaster_Create, Blaster_StageLoad, Blaster_EditorDraw, Blaster_EditorLoad, Blaster_Serialize);
    CreateObject(&Blastoid, "Blastoid", sizeof(EntityBlastoid), sizeof(ObjectBlastoid), Blastoid_Update, Blastoid_LateUpdate, Blastoid_StaticUpdate,
                 Blastoid_Draw, Blastoid_Create, Blastoid_StageLoad, Blastoid_EditorDraw, Blastoid_EditorLoad, Blastoid_Serialize);
    CreateObject(&Bloominator, "Bloominator", sizeof(EntityBloominator), sizeof(ObjectBloominator), Bloominator_Update, Bloominator_LateUpdate,
    ...
    CreateObject(&BouncePlant, "BouncePlant", sizeof(EntityBouncePlant), sizeof(ObjectBouncePlant), BouncePlant_Update, BouncePlant_LateUpdate,
    ...
    CreateObject(&BoundsMarker, "BoundsMarker", sizeof(EntityBoundsMarker), sizeof(ObjectBoundsMarker), BoundsMarker_Update, BoundsMarker_LateUpdate,
    ...
    CreateObject(&BreakableWall, "BreakableWall", sizeof(EntityBreakableWall), sizeof(ObjectBreakableWall), BreakableWall_Update,
    ...
    CreateObject(&BreakBar, "BreakBar", sizeof(EntityBreakBar), sizeof(ObjectBreakBar), BreakBar_Update, BreakBar_LateUpdate, BreakBar_StaticUpdate,
                 BreakBar_Draw, BreakBar_Create, BreakBar_StageLoad, BreakBar_EditorDraw, BreakBar_EditorLoad, BreakBar_Serialize);
    CreateObject(&Bridge, "Bridge", sizeof(EntityBridge), sizeof(ObjectBridge), Bridge_Update, Bridge_LateUpdate, Bridge_StaticUpdate, Bridge_Draw,
                 Bridge_Create, Bridge_StageLoad, Bridge_EditorDraw, Bridge_EditorLoad, Bridge_Serialize);
    CreateObject(&BSS_Collectable, "BSS_Collectable", sizeof(EntityBSS_Collectable), sizeof(ObjectBSS_Collectable), BSS_Collectable_Update,
    ...
    CreateObject(&BSS_Collected, "BSS_Collected", sizeof(EntityBSS_Collected), sizeof(ObjectBSS_Collected), BSS_Collected_Update,
    ...
    CreateObject(&BSS_Horizon, "BSS_Horizon", sizeof(EntityBSS_Horizon), sizeof(ObjectBSS_Horizon), BSS_Horizon_Update, BSS_Horizon_LateUpdate,
    ...
    CreateObject(&BSS_HUD, "BSS_HUD", sizeof(EntityBSS_HUD), sizeof(ObjectBSS_HUD), BSS_HUD_Update, BSS_HUD_LateUpdate, BSS_HUD_StaticUpdate,
                 BSS_HUD_Draw, BSS_HUD_Create, BSS_HUD_StageLoad, BSS_HUD_EditorDraw, BSS_HUD_EditorLoad, BSS_HUD_Serialize);
    CreateObject(&BSS_Message, "BSS_Message", sizeof(EntityBSS_Message), sizeof(ObjectBSS_Message), BSS_Message_Update, BSS_Message_LateUpdate,
    ...
    CreateObject(&BSS_Palette, "BSS_Palette", sizeof(EntityBSS_Palette), sizeof(ObjectBSS_Palette), BSS_Palette_Update, BSS_Palette_LateUpdate,
    ...
    CreateObject(&BSS_Player, "BSS_Player", sizeof(EntityBSS_Player), sizeof(ObjectBSS_Player), BSS_Player_Update, BSS_Player_LateUpdate,
    ...
    CreateObject(&BSS_Setup, "BSS_Setup", sizeof(EntityBSS_Setup), sizeof(ObjectBSS_Setup), BSS_Setup_Update, BSS_Setup_LateUpdate,
                 BSS_Setup_StaticUpdate, BSS_Setup_Draw, BSS_Setup_Create, BSS_Setup_StageLoad, BSS_Setup_EditorDraw, BSS_Setup_EditorLoad,
                 BSS_Setup_Serialize);
    CreateObject(&BuckwildBall, "BuckwildBall", sizeof(EntityBuckwildBall), sizeof(ObjectBuckwildBall), BuckwildBall_Update, BuckwildBall_LateUpdate,
    ...
    CreateObject(&Buggernaut, "Buggernaut", sizeof(EntityBuggernaut), sizeof(ObjectBuggernaut), Buggernaut_Update, Buggernaut_LateUpdate,
    ...
    CreateObject(&Bumpalo, "Bumpalo", sizeof(EntityBumpalo), sizeof(ObjectBumpalo), Bumpalo_Update, Bumpalo_LateUpdate, Bumpalo_StaticUpdate,
                 Bumpalo_Draw, Bumpalo_Create, Bumpalo_StageLoad, Bumpalo_EditorDraw, Bumpalo_EditorLoad, Bumpalo_Serialize);
    CreateObject(&Bungee, "Bungee", sizeof(EntityBungee), sizeof(ObjectBungee), Bungee_Update, Bungee_LateUpdate, Bungee_StaticUpdate, Bungee_Draw,
                 Bungee_Create, Bungee_StageLoad, Bungee_EditorDraw, Bungee_EditorLoad, Bungee_Serialize);
    CreateObject(&BurningLog, "BurningLog", sizeof(EntityBurningLog), sizeof(ObjectBurningLog), BurningLog_Update, BurningLog_LateUpdate,
    ...
    CreateObject(&Button, "Button", sizeof(EntityButton), sizeof(ObjectButton), Button_Update, Button_LateUpdate, Button_StaticUpdate, Button_Draw,
                 Button_Create, Button_StageLoad, Button_EditorDraw, Button_EditorLoad, Button_Serialize);
    CreateObject(&ButtonDoor, "ButtonDoor", sizeof(EntityButtonDoor), sizeof(ObjectButtonDoor), ButtonDoor_Update, ButtonDoor_LateUpdate,
    ...
    CreateObject(&BuzzBomber, "BuzzBomber", sizeof(EntityBuzzBomber), sizeof(ObjectBuzzBomber), BuzzBomber_Update, BuzzBomber_LateUpdate,
    ...
    CreateObject(&BuzzSaw, "BuzzSaw", sizeof(EntityBuzzSaw), sizeof(ObjectBuzzSaw), BuzzSaw_Update, BuzzSaw_LateUpdate, BuzzSaw_StaticUpdate,
                 BuzzSaw_Draw, BuzzSaw_Create, BuzzSaw_StageLoad, BuzzSaw_EditorDraw, BuzzSaw_EditorLoad, BuzzSaw_Serialize);
    CreateObject(&CableWarp, "CableWarp", sizeof(EntityCableWarp), sizeof(ObjectCableWarp), CableWarp_Update, CableWarp_LateUpdate,
                 CableWarp_StaticUpdate, CableWarp_Draw, CableWarp_Create, CableWarp_StageLoad, CableWarp_EditorDraw, CableWarp_EditorLoad,
                 CableWarp_Serialize);
    CreateObject(&Cactula, "Cactula", sizeof(EntityCactula), sizeof(ObjectCactula), Cactula_Update, Cactula_LateUpdate, Cactula_StaticUpdate,
                 Cactula_Draw, Cactula_Create, Cactula_StageLoad, Cactula_EditorDraw, Cactula_EditorLoad, Cactula_Serialize);
    CreateObject(&Camera, "Camera", sizeof(EntityCamera), sizeof(ObjectCamera), Camera_Update, Camera_LateUpdate, Camera_StaticUpdate, Camera_Draw,
                 Camera_Create, Camera_StageLoad, Camera_EditorDraw, Camera_EditorLoad, Camera_Serialize);
    CreateObject(&Canista, "Canista", sizeof(EntityCanista), sizeof(ObjectCanista), Canista_Update, Canista_LateUpdate, Canista_StaticUpdate,
                 Canista_Draw, Canista_Create, Canista_StageLoad, Canista_EditorDraw, Canista_EditorLoad, Canista_Serialize);
    CreateObject(&CaterkillerJr, "CaterkillerJr", sizeof(EntityCaterkillerJr), sizeof(ObjectCaterkillerJr), CaterkillerJr_Update,
    ...
    CreateObject(&ChaosEmerald, "ChaosEmerald", sizeof(EntityChaosEmerald), sizeof(ObjectChaosEmerald), ChaosEmerald_Update, ChaosEmerald_LateUpdate,
    ...
    CreateObject(&CheckerBall, "CheckerBall", sizeof(EntityCheckerBall), sizeof(ObjectCheckerBall), CheckerBall_Update, CheckerBall_LateUpdate,
    ...
    CreateObject(&ChemBubble, "ChemBubble", sizeof(EntityChemBubble), sizeof(ObjectChemBubble), ChemBubble_Update, ChemBubble_LateUpdate,
    ...
    CreateObject(&ChemicalBall, "ChemicalBall", sizeof(EntityChemicalBall), sizeof(ObjectChemicalBall), ChemicalBall_Update, ChemicalBall_LateUpdate,
    ...
    CreateObject(&ChemicalPool, "ChemicalPool", sizeof(EntityChemicalPool), sizeof(ObjectChemicalPool), ChemicalPool_Update, ChemicalPool_LateUpdate,
    ...
    CreateObject(&Chopper, "Chopper", sizeof(EntityChopper), sizeof(ObjectChopper), Chopper_Update, Chopper_LateUpdate, Chopper_StaticUpdate,
                 Chopper_Draw, Chopper_Create, Chopper_StageLoad, Chopper_EditorDraw, Chopper_EditorLoad, Chopper_Serialize);
    CreateObject(&CircleBumper, "CircleBumper", sizeof(EntityCircleBumper), sizeof(ObjectCircleBumper), CircleBumper_Update, CircleBumper_LateUpdate,
    ...
    CreateObject(&Clapperboard, "Clapperboard", sizeof(EntityClapperboard), sizeof(ObjectClapperboard), Clapperboard_Update, Clapperboard_LateUpdate,
    ...
    CreateObject(&Clucker, "Clucker", sizeof(EntityClucker), sizeof(ObjectClucker), Clucker_Update, Clucker_LateUpdate, Clucker_StaticUpdate,
                 Clucker_Draw, Clucker_Create, Clucker_StageLoad, Clucker_EditorDraw, Clucker_EditorLoad, Clucker_Serialize);
    CreateObject(&CollapsingPlatform, "CollapsingPlatform", sizeof(EntityCollapsingPlatform), sizeof(ObjectCollapsingPlatform),
    ...
    CreateObject(&CollapsingSand, "CollapsingSand", sizeof(EntityCollapsingSand), sizeof(ObjectCollapsingSand), CollapsingSand_Update,
    ...
    CreateObject(&Competition, "Competition", sizeof(EntityCompetition), sizeof(ObjectCompetition), Competition_Update, Competition_LateUpdate,
    ...
    CreateObject(&CompetitionMenu, "CompetitionMenu", sizeof(EntityCompetitionMenu), sizeof(ObjectCompetitionMenu), CompetitionMenu_Update,
    ...
    CreateObject(&Constellation, "Constellation", sizeof(EntityConstellation), sizeof(ObjectConstellation), Constellation_Update,
    ...
    CreateObject(&ContinuePlayer, "ContinuePlayer", sizeof(EntityContinuePlayer), sizeof(ObjectContinuePlayer), ContinuePlayer_Update,
    ...
    CreateObject(&ContinueSetup, "ContinueSetup", sizeof(EntityContinueSetup), sizeof(ObjectContinueSetup), ContinueSetup_Update,
    ...
    CreateObject(&ConveyorBelt, "ConveyorBelt", sizeof(EntityConveyorBelt), sizeof(ObjectConveyorBelt), ConveyorBelt_Update, ConveyorBelt_LateUpdate,
    ...
    CreateObject(&ConveyorPlatform, "ConveyorPlatform", sizeof(EntityConveyorPlatform), sizeof(ObjectConveyorPlatform), ConveyorPlatform_Update,
    ...
    CreateObject(&ConveyorWheel, "ConveyorWheel", sizeof(EntityConveyorWheel), sizeof(ObjectConveyorWheel), ConveyorWheel_Update,
    ...
    CreateObject(&CorkscrewPath, "CorkscrewPath", sizeof(EntityCorkscrewPath), sizeof(ObjectCorkscrewPath), CorkscrewPath_Update,
    ...
    CreateObject(&COverlay, "COverlay", sizeof(EntityCOverlay), sizeof(ObjectCOverlay), COverlay_Update, COverlay_LateUpdate, COverlay_StaticUpdate,
                 COverlay_Draw, COverlay_Create, COverlay_StageLoad, COverlay_EditorDraw, COverlay_EditorLoad, COverlay_Serialize);
    CreateObject(&CPZ1Intro, "CPZ1Intro", sizeof(EntityCPZ1Intro), sizeof(ObjectCPZ1Intro), CPZ1Intro_Update, CPZ1Intro_LateUpdate,
                 CPZ1Intro_StaticUpdate, CPZ1Intro_Draw, CPZ1Intro_Create, CPZ1Intro_StageLoad, CPZ1Intro_EditorDraw, CPZ1Intro_EditorLoad,
                 CPZ1Intro_Serialize);
    CreateObject(&CPZ2Outro, "CPZ2Outro", sizeof(EntityCPZ2Outro), sizeof(ObjectCPZ2Outro), CPZ2Outro_Update, CPZ2Outro_LateUpdate,
                 CPZ2Outro_StaticUpdate, CPZ2Outro_Draw, CPZ2Outro_Create, CPZ2Outro_StageLoad, CPZ2Outro_EditorDraw, CPZ2Outro_EditorLoad,
                 CPZ2Outro_Serialize);
    CreateObject(&CPZBoss, "CPZBoss", sizeof(EntityCPZBoss), sizeof(ObjectCPZBoss), CPZBoss_Update, CPZBoss_LateUpdate, CPZBoss_StaticUpdate,
                 CPZBoss_Draw, CPZBoss_Create, CPZBoss_StageLoad, CPZBoss_EditorDraw, CPZBoss_EditorLoad, CPZBoss_Serialize);
    CreateObject(&CPZSetup, "CPZSetup", sizeof(EntityCPZSetup), sizeof(ObjectCPZSetup), CPZSetup_Update, CPZSetup_LateUpdate, CPZSetup_StaticUpdate,
                 CPZSetup_Draw, CPZSetup_Create, CPZSetup_StageLoad, CPZSetup_EditorDraw, CPZSetup_EditorLoad, CPZSetup_Serialize);
    CreateObject(&CPZShutter, "CPZShutter", sizeof(EntityCPZShutter), sizeof(ObjectCPZShutter), CPZShutter_Update, CPZShutter_LateUpdate,
    ...
    CreateObject(&Crabmeat, "Crabmeat", sizeof(EntityCrabmeat), sizeof(ObjectCrabmeat), Crabmeat_Update, Crabmeat_LateUpdate, Crabmeat_StaticUpdate,
                 Crabmeat_Draw, Crabmeat_Create, Crabmeat_StageLoad, Crabmeat_EditorDraw, Crabmeat_EditorLoad, Crabmeat_Serialize);
    CreateObject(&Crane, "Crane", sizeof(EntityCrane), sizeof(ObjectCrane), Crane_Update, Crane_LateUpdate, Crane_StaticUpdate, Crane_Draw,
                 Crane_Create, Crane_StageLoad, Crane_EditorDraw, Crane_EditorLoad, Crane_Serialize);
    CreateObject(&CrashTest, "CrashTest", sizeof(EntityCrashTest), sizeof(ObjectCrashTest), CrashTest_Update, CrashTest_LateUpdate,
                 CrashTest_StaticUpdate, CrashTest_Draw, CrashTest_Create, CrashTest_StageLoad, CrashTest_EditorDraw, CrashTest_EditorLoad,
                 CrashTest_Serialize);
    CreateObject(&Crate, "Crate", sizeof(EntityCrate), sizeof(ObjectCrate), Crate_Update, Crate_LateUpdate, Crate_StaticUpdate, Crate_Draw,
                 Crate_Create, Crate_StageLoad, Crate_EditorDraw, Crate_EditorLoad, Crate_Serialize);
    CreateObject(&CreditsSetup, "CreditsSetup", sizeof(EntityCreditsSetup), sizeof(ObjectCreditsSetup), CreditsSetup_Update, CreditsSetup_LateUpdate,
    ...
    CreateObject(&CrimsonEye, "CrimsonEye", sizeof(EntityCrimsonEye), sizeof(ObjectCrimsonEye), CrimsonEye_Update, CrimsonEye_LateUpdate,
    ...
    CreateObject(&Current, "Current", sizeof(EntityCurrent), sizeof(ObjectCurrent), Current_Update, Current_LateUpdate, Current_StaticUpdate,
                 Current_Draw, Current_Create, Current_StageLoad, Current_EditorDraw, Current_EditorLoad, Current_Serialize);
    CreateObject(&CutsceneHBH, "CutsceneHBH", sizeof(EntityCutsceneHBH), sizeof(ObjectCutsceneHBH), CutsceneHBH_Update, CutsceneHBH_LateUpdate,
    ...
    CreateObject(&CutsceneSeq, "CutsceneSeq", sizeof(EntityCutsceneSeq), sizeof(ObjectCutsceneSeq), CutsceneSeq_Update, CutsceneSeq_LateUpdate,
    ...
    CreateObject(&Cylinder, "Cylinder", sizeof(EntityCylinder), sizeof(ObjectCylinder), Cylinder_Update, Cylinder_LateUpdate, Cylinder_StaticUpdate,
                 Cylinder_Draw, Cylinder_Create, Cylinder_StageLoad, Cylinder_EditorDraw, Cylinder_EditorLoad, Cylinder_Serialize);
    CreateObject(&DAControl, "DAControl", sizeof(EntityDAControl), sizeof(ObjectDAControl), DAControl_Update, DAControl_LateUpdate,
                 DAControl_StaticUpdate, DAControl_Draw, DAControl_Create, DAControl_StageLoad, DAControl_EditorDraw, DAControl_EditorLoad,
                 DAControl_Serialize);
    CreateObject(&Dango, "Dango", sizeof(EntityDango), sizeof(ObjectDango), Dango_Update, Dango_LateUpdate, Dango_StaticUpdate, Dango_Draw,
                 Dango_Create, Dango_StageLoad, Dango_EditorDraw, Dango_EditorLoad, Dango_Serialize);
    CreateObject(&DASetup, "DASetup", sizeof(EntityDASetup), sizeof(ObjectDASetup), DASetup_Update, DASetup_LateUpdate, DASetup_StaticUpdate,
                 DASetup_Draw, DASetup_Create, DASetup_StageLoad, DASetup_EditorDraw, DASetup_EditorLoad, DASetup_Serialize);
    CreateObject(&DashLift, "DashLift", sizeof(EntityDashLift), sizeof(ObjectDashLift), DashLift_Update, DashLift_LateUpdate, DashLift_StaticUpdate,
                 DashLift_Draw, DashLift_Create, DashLift_StageLoad, DashLift_EditorDraw, DashLift_EditorLoad, DashLift_Serialize);
    CreateObject(&DBTower, "DBTower", sizeof(EntityDBTower), sizeof(ObjectDBTower), DBTower_Update, DBTower_LateUpdate, DBTower_StaticUpdate,
                 DBTower_Draw, DBTower_Create, DBTower_StageLoad, DBTower_EditorDraw, DBTower_EditorLoad, DBTower_Serialize);
    CreateObject(&DCEvent, "DCEvent", sizeof(EntityDCEvent), sizeof(ObjectDCEvent), DCEvent_Update, DCEvent_LateUpdate, DCEvent_StaticUpdate,
                 DCEvent_Draw, DCEvent_Create, DCEvent_StageLoad, DCEvent_EditorDraw, DCEvent_EditorLoad, DCEvent_Serialize);
    CreateObject(&DDWrecker, "DDWrecker", sizeof(EntityDDWrecker), sizeof(ObjectDDWrecker), DDWrecker_Update, DDWrecker_LateUpdate,
                 DDWrecker_StaticUpdate, DDWrecker_Draw, DDWrecker_Create, DDWrecker_StageLoad, DDWrecker_EditorDraw, DDWrecker_EditorLoad,
                 DDWrecker_Serialize);
    CreateObject(&Debris, "Debris", sizeof(EntityDebris), sizeof(ObjectDebris), Debris_Update, Debris_LateUpdate, Debris_StaticUpdate, Debris_Draw,
                 Debris_Create, Debris_StageLoad, Debris_EditorDraw, Debris_EditorLoad, Debris_Serialize);
    CreateObject(&DebugMode, "DebugMode", sizeof(EntityDebugMode), sizeof(ObjectDebugMode), DebugMode_Update, DebugMode_LateUpdate,
                 DebugMode_StaticUpdate, DebugMode_Draw, DebugMode_Create, DebugMode_StageLoad, DebugMode_EditorDraw, DebugMode_EditorLoad,
                 DebugMode_Serialize);
    CreateObject(&Decoration, "Decoration", sizeof(EntityDecoration), sizeof(ObjectDecoration), Decoration_Update, Decoration_LateUpdate,
    ...
    CreateObject(&DERobot, "DERobot", sizeof(EntityDERobot), sizeof(ObjectDERobot), DERobot_Update, DERobot_LateUpdate, DERobot_StaticUpdate,
                 DERobot_Draw, DERobot_Create, DERobot_StageLoad, DERobot_EditorDraw, DERobot_EditorLoad, DERobot_Serialize);
    CreateObject(&DialogRunner, "DialogRunner", sizeof(EntityDialogRunner), sizeof(ObjectDialogRunner), DialogRunner_Update, DialogRunner_LateUpdate,
    ...
    CreateObject(&DirectorChair, "DirectorChair", sizeof(EntityDirectorChair), sizeof(ObjectDirectorChair), DirectorChair_Update,
    ...
    CreateObject(&DiveEggman, "DiveEggman", sizeof(EntityDiveEggman), sizeof(ObjectDiveEggman), DiveEggman_Update, DiveEggman_LateUpdate,
    ...
    CreateObject(&DNARiser, "DNARiser", sizeof(EntityDNARiser), sizeof(ObjectDNARiser), DNARiser_Update, DNARiser_LateUpdate, DNARiser_StaticUpdate,
                 DNARiser_Draw, DNARiser_Create, DNARiser_StageLoad, DNARiser_EditorDraw, DNARiser_EditorLoad, DNARiser_Serialize);
    CreateObject(&DoorTrigger, "DoorTrigger", sizeof(EntityDoorTrigger), sizeof(ObjectDoorTrigger), DoorTrigger_Update, DoorTrigger_LateUpdate,
    ...
    CreateObject(&Dragonfly, "Dragonfly", sizeof(EntityDragonfly), sizeof(ObjectDragonfly), Dragonfly_Update, Dragonfly_LateUpdate,
                 Dragonfly_StaticUpdate, Dragonfly_Draw, Dragonfly_Create, Dragonfly_StageLoad, Dragonfly_EditorDraw, Dragonfly_EditorLoad,
                 Dragonfly_Serialize);
    CreateObject(&Drillerdroid, "Drillerdroid", sizeof(EntityDrillerdroid), sizeof(ObjectDrillerdroid), Drillerdroid_Update, Drillerdroid_LateUpdate,
    ...
    CreateObject(&DrillerdroidO, "DrillerdroidO", sizeof(EntityDrillerdroidO), sizeof(ObjectDrillerdroidO), DrillerdroidO_Update,
    ...
    CreateObject(&Dust, "Dust", sizeof(EntityDust), sizeof(ObjectDust), Dust_Update, Dust_LateUpdate, Dust_StaticUpdate, Dust_Draw, Dust_Create,
                 Dust_StageLoad, Dust_EditorDraw, Dust_EditorLoad, Dust_Serialize);
    CreateObject(&EggLoco, "EggLoco", sizeof(EntityEggLoco), sizeof(ObjectEggLoco), EggLoco_Update, EggLoco_LateUpdate, EggLoco_StaticUpdate,
                 EggLoco_Draw, EggLoco_Create, EggLoco_StageLoad, EggLoco_EditorDraw, EggLoco_EditorLoad, EggLoco_Serialize);
    CreateObject(&Eggman, "Eggman", sizeof(EntityEggman), sizeof(ObjectEggman), Eggman_Update, Eggman_LateUpdate, Eggman_StaticUpdate, Eggman_Draw,
                 Eggman_Create, Eggman_StageLoad, Eggman_EditorDraw, Eggman_EditorLoad, Eggman_Serialize);
    CreateObject(&EggPistonsMKII, "EggPistonsMKII", sizeof(EntityEggPistonsMKII), sizeof(ObjectEggPistonsMKII), EggPistonsMKII_Update,
    ...
    CreateObject(&EggPrison, "EggPrison", sizeof(EntityEggPrison), sizeof(ObjectEggPrison), EggPrison_Update, EggPrison_LateUpdate,
                 EggPrison_StaticUpdate, EggPrison_Draw, EggPrison_Create, EggPrison_StageLoad, EggPrison_EditorDraw, EggPrison_EditorLoad,
                 EggPrison_Serialize);
    CreateObject(&EggTower, "EggTower", sizeof(EntityEggTower), sizeof(ObjectEggTower), EggTower_Update, EggTower_LateUpdate, EggTower_StaticUpdate,
                 EggTower_Draw, EggTower_Create, EggTower_StageLoad, EggTower_EditorDraw, EggTower_EditorLoad, EggTower_Serialize);
    CreateObject(&EggTV, "EggTV", sizeof(EntityEggTV), sizeof(ObjectEggTV), EggTV_Update, EggTV_LateUpdate, EggTV_StaticUpdate, EggTV_Draw,
                 EggTV_Create, EggTV_StageLoad, EggTV_EditorDraw, EggTV_EditorLoad, EggTV_Serialize);
    CreateObject(&ElectroMagnet, "ElectroMagnet", sizeof(EntityElectroMagnet), sizeof(ObjectElectroMagnet), ElectroMagnet_Update,
    ...
    CreateObject(&EncoreGoodEnd, "EncoreGoodEnd", sizeof(EntityEncoreGoodEnd), sizeof(ObjectEncoreGoodEnd), EncoreGoodEnd_Update,
    ...
    CreateObject(&EncoreIntro, "EncoreIntro", sizeof(EntityEncoreIntro), sizeof(ObjectEncoreIntro), EncoreIntro_Update, EncoreIntro_LateUpdate,
    ...
    CreateObject(&EncoreRoute, "EncoreRoute", sizeof(EntityEncoreRoute), sizeof(ObjectEncoreRoute), EncoreRoute_Update, EncoreRoute_LateUpdate,
    ...
    CreateObject(&ERZGunner, "ERZGunner", sizeof(EntityERZGunner), sizeof(ObjectERZGunner), ERZGunner_Update, ERZGunner_LateUpdate,
                 ERZGunner_StaticUpdate, ERZGunner_Draw, ERZGunner_Create, ERZGunner_StageLoad, ERZGunner_EditorDraw, ERZGunner_EditorLoad,
                 ERZGunner_Serialize);
    CreateObject(&ERZKing, "ERZKing", sizeof(EntityERZKing), sizeof(ObjectERZKing), ERZKing_Update, ERZKing_LateUpdate, ERZKing_StaticUpdate,
                 ERZKing_Draw, ERZKing_Create, ERZKing_StageLoad, ERZKing_EditorDraw, ERZKing_EditorLoad, ERZKing_Serialize);
    CreateObject(&ERZMystic, "ERZMystic", sizeof(EntityERZMystic), sizeof(ObjectERZMystic), ERZMystic_Update, ERZMystic_LateUpdate,
                 ERZMystic_StaticUpdate, ERZMystic_Draw, ERZMystic_Create, ERZMystic_StageLoad, ERZMystic_EditorDraw, ERZMystic_EditorLoad,
                 ERZMystic_Serialize);
    CreateObject(&ERZOutro, "ERZOutro", sizeof(EntityERZOutro), sizeof(ObjectERZOutro), ERZOutro_Update, ERZOutro_LateUpdate, ERZOutro_StaticUpdate,
                 ERZOutro_Draw, ERZOutro_Create, ERZOutro_StageLoad, ERZOutro_EditorDraw, ERZOutro_EditorLoad, ERZOutro_Serialize);
    CreateObject(&ERZRider, "ERZRider", sizeof(EntityERZRider), sizeof(ObjectERZRider), ERZRider_Update, ERZRider_LateUpdate, ERZRider_StaticUpdate,
                 ERZRider_Draw, ERZRider_Create, ERZRider_StageLoad, ERZRider_EditorDraw, ERZRider_EditorLoad, ERZRider_Serialize);
    CreateObject(&ERZSetup, "ERZSetup", sizeof(EntityERZSetup), sizeof(ObjectERZSetup), ERZSetup_Update, ERZSetup_LateUpdate, ERZSetup_StaticUpdate,
                 ERZSetup_Draw, ERZSetup_Create, ERZSetup_StageLoad, ERZSetup_EditorDraw, ERZSetup_EditorLoad, ERZSetup_Serialize);
    CreateObject(&ERZShinobi, "ERZShinobi", sizeof(EntityERZShinobi), sizeof(ObjectERZShinobi), ERZShinobi_Update, ERZShinobi_LateUpdate,
    ...
    CreateObject(&ERZStart, "ERZStart", sizeof(EntityERZStart), sizeof(ObjectERZStart), ERZStart_Update, ERZStart_LateUpdate, ERZStart_StaticUpdate,
                 ERZStart_Draw, ERZStart_Create, ERZStart_StageLoad, ERZStart_EditorDraw, ERZStart_EditorLoad, ERZStart_Serialize);
    CreateObject(&EscapeCar, "EscapeCar", sizeof(EntityEscapeCar), sizeof(ObjectEscapeCar), EscapeCar_Update, EscapeCar_LateUpdate,
                 EscapeCar_StaticUpdate, EscapeCar_Draw, EscapeCar_Create, EscapeCar_StageLoad, EscapeCar_EditorDraw, EscapeCar_EditorLoad,
                 EscapeCar_Serialize);
    CreateObject(&Explosion, "Explosion", sizeof(EntityExplosion), sizeof(ObjectExplosion), Explosion_Update, Explosion_LateUpdate,
                 Explosion_StaticUpdate, Explosion_Draw, Explosion_Create, Explosion_StageLoad, Explosion_EditorDraw, Explosion_EditorLoad,
                 Explosion_Serialize);
    CreateObject(&ExtrasMenu, "ExtrasMenu", sizeof(EntityExtrasMenu), sizeof(ObjectExtrasMenu), ExtrasMenu_Update, ExtrasMenu_LateUpdate,
    ...
    CreateObject(&Fan, "Fan", sizeof(EntityFan), sizeof(ObjectFan), Fan_Update, Fan_LateUpdate, Fan_StaticUpdate, Fan_Draw, Fan_Create, Fan_StageLoad,
                 Fan_EditorDraw, Fan_EditorLoad, Fan_Serialize);
    CreateObject(&FarPlane, "FarPlane", sizeof(EntityFarPlane), sizeof(ObjectFarPlane), FarPlane_Update, FarPlane_LateUpdate, FarPlane_StaticUpdate,
                 FarPlane_Draw, FarPlane_Create, FarPlane_StageLoad, FarPlane_EditorDraw, FarPlane_EditorLoad, FarPlane_Serialize);
    CreateObject(&FBZ1Outro, "FBZ1Outro", sizeof(EntityFBZ1Outro), sizeof(ObjectFBZ1Outro), FBZ1Outro_Update, FBZ1Outro_LateUpdate,
                 FBZ1Outro_StaticUpdate, FBZ1Outro_Draw, FBZ1Outro_Create, FBZ1Outro_StageLoad, FBZ1Outro_EditorDraw, FBZ1Outro_EditorLoad,
                 FBZ1Outro_Serialize);
    CreateObject(&FBZ2Outro, "FBZ2Outro", sizeof(EntityFBZ2Outro), sizeof(ObjectFBZ2Outro), FBZ2Outro_Update, FBZ2Outro_LateUpdate,
                 FBZ2Outro_StaticUpdate, FBZ2Outro_Draw, FBZ2Outro_Create, FBZ2Outro_StageLoad, FBZ2Outro_EditorDraw, FBZ2Outro_EditorLoad,
                 FBZ2Outro_Serialize);
    CreateObject(&FBZFan, "FBZFan", sizeof(EntityFBZFan), sizeof(ObjectFBZFan), FBZFan_Update, FBZFan_LateUpdate, FBZFan_StaticUpdate, FBZFan_Draw,
                 FBZFan_Create, FBZFan_StageLoad, FBZFan_EditorDraw, FBZFan_EditorLoad, FBZFan_Serialize);
    CreateObject(&FBZMissile, "FBZMissile", sizeof(EntityFBZMissile), sizeof(ObjectFBZMissile), FBZMissile_Update, FBZMissile_LateUpdate,
    ...
    CreateObject(&FBZSetup, "FBZSetup", sizeof(EntityFBZSetup), sizeof(ObjectFBZSetup), FBZSetup_Update, FBZSetup_LateUpdate, FBZSetup_StaticUpdate,
                 FBZSetup_Draw, FBZSetup_Create, FBZSetup_StageLoad, FBZSetup_EditorDraw, FBZSetup_EditorLoad, FBZSetup_Serialize);
    CreateObject(&FBZSinkTrash, "FBZSinkTrash", sizeof(EntityFBZSinkTrash), sizeof(ObjectFBZSinkTrash), FBZSinkTrash_Update, FBZSinkTrash_LateUpdate,
    ...
    CreateObject(&FBZStorm, "FBZStorm", sizeof(EntityFBZStorm), sizeof(ObjectFBZStorm), FBZStorm_Update, FBZStorm_LateUpdate, FBZStorm_StaticUpdate,
                 FBZStorm_Draw, FBZStorm_Create, FBZStorm_StageLoad, FBZStorm_EditorDraw, FBZStorm_EditorLoad, FBZStorm_Serialize);
    CreateObject(&FBZTrash, "FBZTrash", sizeof(EntityFBZTrash), sizeof(ObjectFBZTrash), FBZTrash_Update, FBZTrash_LateUpdate, FBZTrash_StaticUpdate,
                 FBZTrash_Draw, FBZTrash_Create, FBZTrash_StageLoad, FBZTrash_EditorDraw, FBZTrash_EditorLoad, FBZTrash_Serialize);
    CreateObject(&FernParallax, "FernParallax", sizeof(EntityFernParallax), sizeof(ObjectFernParallax), FernParallax_Update, FernParallax_LateUpdate,
    ...
    CreateObject(&FilmProjector, "FilmProjector", sizeof(EntityFilmProjector), sizeof(ObjectFilmProjector), FilmProjector_Update,
    ...
    CreateObject(&FilmReel, "FilmReel", sizeof(EntityFilmReel), sizeof(ObjectFilmReel), FilmReel_Update, FilmReel_LateUpdate, FilmReel_StaticUpdate,
                 FilmReel_Draw, FilmReel_Create, FilmReel_StageLoad, FilmReel_EditorDraw, FilmReel_EditorLoad, FilmReel_Serialize);
    CreateObject(&Fireflies, "Fireflies", sizeof(EntityFireflies), sizeof(ObjectFireflies), Fireflies_Update, Fireflies_LateUpdate,
                 Fireflies_StaticUpdate, Fireflies_Draw, Fireflies_Create, Fireflies_StageLoad, Fireflies_EditorDraw, Fireflies_EditorLoad,
                 Fireflies_Serialize);
    CreateObject(&Firework, "Firework", sizeof(EntityFirework), sizeof(ObjectFirework), Firework_Update, Firework_LateUpdate, Firework_StaticUpdate,
                 Firework_Draw, Firework_Create, Firework_StageLoad, Firework_EditorDraw, Firework_EditorLoad, Firework_Serialize);
    CreateObject(&Fireworm, "Fireworm", sizeof(EntityFireworm), sizeof(ObjectFireworm), Fireworm_Update, Fireworm_LateUpdate, Fireworm_StaticUpdate,
                 Fireworm_Draw, Fireworm_Create, Fireworm_StageLoad, Fireworm_EditorDraw, Fireworm_EditorLoad, Fireworm_Serialize);
    CreateObject(&FlameSpring, "FlameSpring", sizeof(EntityFlameSpring), sizeof(ObjectFlameSpring), FlameSpring_Update, FlameSpring_LateUpdate,
    ...
    CreateObject(&Flamethrower, "Flamethrower", sizeof(EntityFlamethrower), sizeof(ObjectFlamethrower), Flamethrower_Update, Flamethrower_LateUpdate,
    ...
    CreateObject(&FlasherMKII, "FlasherMKII", sizeof(EntityFlasherMKII), sizeof(ObjectFlasherMKII), FlasherMKII_Update, FlasherMKII_LateUpdate,
    ...
    CreateObject(&FlingRamp, "FlingRamp", sizeof(EntityFlingRamp), sizeof(ObjectFlingRamp), FlingRamp_Update, FlingRamp_LateUpdate,
                 FlingRamp_StaticUpdate, FlingRamp_Draw, FlingRamp_Create, FlingRamp_StageLoad, FlingRamp_EditorDraw, FlingRamp_EditorLoad,
                 FlingRamp_Serialize);
    CreateObject(&Flipper, "Flipper", sizeof(EntityFlipper), sizeof(ObjectFlipper), Flipper_Update, Flipper_LateUpdate, Flipper_StaticUpdate,
                 Flipper_Draw, Flipper_Create, Flipper_StageLoad, Flipper_EditorDraw, Flipper_EditorLoad, Flipper_Serialize);
    CreateObject(&FlowerPod, "FlowerPod", sizeof(EntityFlowerPod), sizeof(ObjectFlowerPod), FlowerPod_Update, FlowerPod_LateUpdate,
                 FlowerPod_StaticUpdate, FlowerPod_Draw, FlowerPod_Create, FlowerPod_StageLoad, FlowerPod_EditorDraw, FlowerPod_EditorLoad,
                 FlowerPod_Serialize);
    CreateObject(&FoldingPlatform, "FoldingPlatform", sizeof(EntityFoldingPlatform), sizeof(ObjectFoldingPlatform), FoldingPlatform_Update,
    ...
    CreateObject(&ForceSpin, "ForceSpin", sizeof(EntityForceSpin), sizeof(ObjectForceSpin), ForceSpin_Update, ForceSpin_LateUpdate,
                 ForceSpin_StaticUpdate, ForceSpin_Draw, ForceSpin_Create, ForceSpin_StageLoad, ForceSpin_EditorDraw, ForceSpin_EditorLoad,
                 ForceSpin_Serialize);
    CreateObject(&ForceUnstick, "ForceUnstick", sizeof(EntityForceUnstick), sizeof(ObjectForceUnstick), ForceUnstick_Update, ForceUnstick_LateUpdate,
    ...
    CreateObject(&FrostThrower, "FrostThrower", sizeof(EntityFrostThrower), sizeof(ObjectFrostThrower), FrostThrower_Update, FrostThrower_LateUpdate,
    ...
    CreateObject(&Funnel, "Funnel", sizeof(EntityFunnel), sizeof(ObjectFunnel), Funnel_Update, Funnel_LateUpdate, Funnel_StaticUpdate, Funnel_Draw,
                 Funnel_Create, Funnel_StageLoad, Funnel_EditorDraw, Funnel_EditorLoad, Funnel_Serialize);
    CreateObject(&FXExpandRing, "FXExpandRing", sizeof(EntityFXExpandRing), sizeof(ObjectFXExpandRing), FXExpandRing_Update, FXExpandRing_LateUpdate,
    ...
    CreateObject(&FXFade, "FXFade", sizeof(EntityFXFade), sizeof(ObjectFXFade), FXFade_Update, FXFade_LateUpdate, FXFade_StaticUpdate, FXFade_Draw,
                 FXFade_Create, FXFade_StageLoad, FXFade_EditorDraw, FXFade_EditorLoad, FXFade_Serialize);
    CreateObject(&FXRuby, "FXRuby", sizeof(EntityFXRuby), sizeof(ObjectFXRuby), FXRuby_Update, FXRuby_LateUpdate, FXRuby_StaticUpdate, FXRuby_Draw,
                 FXRuby_Create, FXRuby_StageLoad, FXRuby_EditorDraw, FXRuby_EditorLoad, FXRuby_Serialize);
    CreateObject(&FXSpinRay, "FXSpinRay", sizeof(EntityFXSpinRay), sizeof(ObjectFXSpinRay), FXSpinRay_Update, FXSpinRay_LateUpdate,
                 FXSpinRay_StaticUpdate, FXSpinRay_Draw, FXSpinRay_Create, FXSpinRay_StageLoad, FXSpinRay_EditorDraw, FXSpinRay_EditorLoad,
                 FXSpinRay_Serialize);
    CreateObject(&FXTrail, "FXTrail", sizeof(EntityFXTrail), sizeof(ObjectFXTrail), FXTrail_Update, FXTrail_LateUpdate, FXTrail_StaticUpdate,
                 FXTrail_Draw, FXTrail_Create, FXTrail_StageLoad, FXTrail_EditorDraw, FXTrail_EditorLoad, FXTrail_Serialize);
    CreateObject(&FXWaveRing, "FXWaveRing", sizeof(EntityFXWaveRing), sizeof(ObjectFXWaveRing), FXWaveRing_Update, FXWaveRing_LateUpdate,
    ...
    CreateObject(&Gachapandora, "Gachapandora", sizeof(EntityGachapandora), sizeof(ObjectGachapandora), Gachapandora_Update, Gachapandora_LateUpdate,
    ...
    CreateObject(&GameOver, "GameOver", sizeof(EntityGameOver), sizeof(ObjectGameOver), GameOver_Update, GameOver_LateUpdate, GameOver_StaticUpdate,
                 GameOver_Draw, GameOver_Create, GameOver_StageLoad, GameOver_EditorDraw, GameOver_EditorLoad, GameOver_Serialize);
    CreateObject(&GasPlatform, "GasPlatform", sizeof(EntityGasPlatform), sizeof(ObjectGasPlatform), GasPlatform_Update, GasPlatform_LateUpdate,
    ...
    CreateObject(&GenericTrigger, "GenericTrigger", sizeof(EntityGenericTrigger), sizeof(ObjectGenericTrigger), GenericTrigger_Update,
    ...
    CreateObject(&GHZ2Outro, "GHZ2Outro", sizeof(EntityGHZ2Outro), sizeof(ObjectGHZ2Outro), GHZ2Outro_Update, GHZ2Outro_LateUpdate,
                 GHZ2Outro_StaticUpdate, GHZ2Outro_Draw, GHZ2Outro_Create, GHZ2Outro_StageLoad, GHZ2Outro_EditorDraw, GHZ2Outro_EditorLoad,
                 GHZ2Outro_Serialize);
    CreateObject(&GHZCutsceneK, "GHZCutsceneK", sizeof(EntityGHZCutsceneK), sizeof(ObjectGHZCutsceneK), GHZCutsceneK_Update, GHZCutsceneK_LateUpdate,
    ...
    CreateObject(&GHZCutsceneST, "GHZCutsceneST", sizeof(EntityGHZCutsceneST), sizeof(ObjectGHZCutsceneST), GHZCutsceneST_Update,
    ...
    CreateObject(&GHZSetup, "GHZSetup", sizeof(EntityGHZSetup), sizeof(ObjectGHZSetup), GHZSetup_Update, GHZSetup_LateUpdate, GHZSetup_StaticUpdate,
                 GHZSetup_Draw, GHZSetup_Create, GHZSetup_StageLoad, GHZSetup_EditorDraw, GHZSetup_EditorLoad, GHZSetup_Serialize);
    CreateObject(&GiantPistol, "GiantPistol", sizeof(EntityGiantPistol), sizeof(ObjectGiantPistol), GiantPistol_Update, GiantPistol_LateUpdate,
    ...
    CreateObject(&GigaMetal, "GigaMetal", sizeof(EntityGigaMetal), sizeof(ObjectGigaMetal), GigaMetal_Update, GigaMetal_LateUpdate,
                 GigaMetal_StaticUpdate, GigaMetal_Draw, GigaMetal_Create, GigaMetal_StageLoad, GigaMetal_EditorDraw, GigaMetal_EditorLoad,
                 GigaMetal_Serialize);
    CreateObject(&Gondola, "Gondola", sizeof(EntityGondola), sizeof(ObjectGondola), Gondola_Update, Gondola_LateUpdate, Gondola_StaticUpdate,
                 Gondola_Draw, Gondola_Create, Gondola_StageLoad, Gondola_EditorDraw, Gondola_EditorLoad, Gondola_Serialize);
    CreateObject(&Grabber, "Grabber", sizeof(EntityGrabber), sizeof(ObjectGrabber), Grabber_Update, Grabber_LateUpdate, Grabber_StaticUpdate,
                 Grabber_Draw, Grabber_Create, Grabber_StageLoad, Grabber_EditorDraw, Grabber_EditorLoad, Grabber_Serialize);
    CreateObject(&GreenScreen, "GreenScreen", sizeof(EntityGreenScreen), sizeof(ObjectGreenScreen), GreenScreen_Update, GreenScreen_LateUpdate,
    ...
    CreateObject(&GymBar, "GymBar", sizeof(EntityGymBar), sizeof(ObjectGymBar), GymBar_Update, GymBar_LateUpdate, GymBar_StaticUpdate, GymBar_Draw,
                 GymBar_Create, GymBar_StageLoad, GymBar_EditorDraw, GymBar_EditorLoad, GymBar_Serialize);
    CreateObject(&HandLauncher, "HandLauncher", sizeof(EntityHandLauncher), sizeof(ObjectHandLauncher), HandLauncher_Update, HandLauncher_LateUpdate,
    ...
    CreateObject(&HangConveyor, "HangConveyor", sizeof(EntityHangConveyor), sizeof(ObjectHangConveyor), HangConveyor_Update, HangConveyor_LateUpdate,
    ...
    CreateObject(&HangGlider, "HangGlider", sizeof(EntityHangGlider), sizeof(ObjectHangGlider), HangGlider_Update, HangGlider_LateUpdate,
    ...
    CreateObject(&HangPoint, "HangPoint", sizeof(EntityHangPoint), sizeof(ObjectHangPoint), HangPoint_Update, HangPoint_LateUpdate,
                 HangPoint_StaticUpdate, HangPoint_Draw, HangPoint_Create, HangPoint_StageLoad, HangPoint_EditorDraw, HangPoint_EditorLoad,
                 HangPoint_Serialize);
    CreateObject(&Hatch, "Hatch", sizeof(EntityHatch), sizeof(ObjectHatch), Hatch_Update, Hatch_LateUpdate, Hatch_StaticUpdate, Hatch_Draw,
                 Hatch_Create, Hatch_StageLoad, Hatch_EditorDraw, Hatch_EditorLoad, Hatch_Serialize);
    CreateObject(&Hatterkiller, "Hatterkiller", sizeof(EntityHatterkiller), sizeof(ObjectHatterkiller), Hatterkiller_Update, Hatterkiller_LateUpdate,
    ...
    CreateObject(&HCZ1Intro, "HCZ1Intro", sizeof(EntityHCZ1Intro), sizeof(ObjectHCZ1Intro), HCZ1Intro_Update, HCZ1Intro_LateUpdate,
                 HCZ1Intro_StaticUpdate, HCZ1Intro_Draw, HCZ1Intro_Create, HCZ1Intro_StageLoad, HCZ1Intro_EditorDraw, HCZ1Intro_EditorLoad,
                 HCZ1Intro_Serialize);
    CreateObject(&HCZOneWayDoor, "HCZOneWayDoor", sizeof(EntityHCZOneWayDoor), sizeof(ObjectHCZOneWayDoor), HCZOneWayDoor_Update,
    ...
    CreateObject(&HCZSetup, "HCZSetup", sizeof(EntityHCZSetup), sizeof(ObjectHCZSetup), HCZSetup_Update, HCZSetup_LateUpdate, HCZSetup_StaticUpdate,
                 HCZSetup_Draw, HCZSetup_Create, HCZSetup_StageLoad, HCZSetup_EditorDraw, HCZSetup_EditorLoad, HCZSetup_Serialize);
    CreateObject(&HCZSpikeBall, "HCZSpikeBall", sizeof(EntityHCZSpikeBall), sizeof(ObjectHCZSpikeBall), HCZSpikeBall_Update, HCZSpikeBall_LateUpdate,
    ...
    CreateObject(&HeavyGunner, "HeavyGunner", sizeof(EntityHeavyGunner), sizeof(ObjectHeavyGunner), HeavyGunner_Update, HeavyGunner_LateUpdate,
    ...
    CreateObject(&HeavyKing, "HeavyKing", sizeof(EntityHeavyKing), sizeof(ObjectHeavyKing), HeavyKing_Update, HeavyKing_LateUpdate,
                 HeavyKing_StaticUpdate, HeavyKing_Draw, HeavyKing_Create, HeavyKing_StageLoad, HeavyKing_EditorDraw, HeavyKing_EditorLoad,
                 HeavyKing_Serialize);
    CreateObject(&HeavyMystic, "HeavyMystic", sizeof(EntityHeavyMystic), sizeof(ObjectHeavyMystic), HeavyMystic_Update, HeavyMystic_LateUpdate,
    ...
    CreateObject(&HeavyRider, "HeavyRider", sizeof(EntityHeavyRider), sizeof(ObjectHeavyRider), HeavyRider_Update, HeavyRider_LateUpdate,
    ...
    CreateObject(&HeavyShinobi, "HeavyShinobi", sizeof(EntityHeavyShinobi), sizeof(ObjectHeavyShinobi), HeavyShinobi_Update, HeavyShinobi_LateUpdate,
    ...
    CreateObject(&HiLoSign, "HiLoSign", sizeof(EntityHiLoSign), sizeof(ObjectHiLoSign), HiLoSign_Update, HiLoSign_LateUpdate, HiLoSign_StaticUpdate,
                 HiLoSign_Draw, HiLoSign_Create, HiLoSign_StageLoad, HiLoSign_EditorDraw, HiLoSign_EditorLoad, HiLoSign_Serialize);
    CreateObject(&Honkytonk, "Honkytonk", sizeof(EntityHonkytonk), sizeof(ObjectHonkytonk), Honkytonk_Update, Honkytonk_LateUpdate,
                 Honkytonk_StaticUpdate, Honkytonk_Draw, Honkytonk_Create, Honkytonk_StageLoad, Honkytonk_EditorDraw, Honkytonk_EditorLoad,
                 Honkytonk_Serialize);
    CreateObject(&Hotaru, "Hotaru", sizeof(EntityHotaru), sizeof(ObjectHotaru), Hotaru_Update, Hotaru_LateUpdate, Hotaru_StaticUpdate, Hotaru_Draw,
                 Hotaru_Create, Hotaru_StageLoad, Hotaru_EditorDraw, Hotaru_EditorLoad, Hotaru_Serialize);
    CreateObject(&HotaruHiWatt, "HotaruHiWatt", sizeof(EntityHotaruHiWatt), sizeof(ObjectHotaruHiWatt), HotaruHiWatt_Update, HotaruHiWatt_LateUpdate,
    ...
    CreateObject(&HotaruMKII, "HotaruMKII", sizeof(EntityHotaruMKII), sizeof(ObjectHotaruMKII), HotaruMKII_Update, HotaruMKII_LateUpdate,
    ...
    CreateObject(&HPZEmerald, "HPZEmerald", sizeof(EntityHPZEmerald), sizeof(ObjectHPZEmerald), HPZEmerald_Update, HPZEmerald_LateUpdate,
    ...
    CreateObject(&HUD, "HUD", sizeof(EntityHUD), sizeof(ObjectHUD), HUD_Update, HUD_LateUpdate, HUD_StaticUpdate, HUD_Draw, HUD_Create, HUD_StageLoad,
                 HUD_EditorDraw, HUD_EditorLoad, HUD_Serialize);
    CreateObject(&Ice, "Ice", sizeof(EntityIce), sizeof(ObjectIce), Ice_Update, Ice_LateUpdate, Ice_StaticUpdate, Ice_Draw, Ice_Create, Ice_StageLoad,
                 Ice_EditorDraw, Ice_EditorLoad, Ice_Serialize);
    CreateObject(&IceBomba, "IceBomba", sizeof(EntityIceBomba), sizeof(ObjectIceBomba), IceBomba_Update, IceBomba_LateUpdate, IceBomba_StaticUpdate,
                 IceBomba_Draw, IceBomba_Create, IceBomba_StageLoad, IceBomba_EditorDraw, IceBomba_EditorLoad, IceBomba_Serialize);
    CreateObject(&IceSpring, "IceSpring", sizeof(EntityIceSpring), sizeof(ObjectIceSpring), IceSpring_Update, IceSpring_LateUpdate,
                 IceSpring_StaticUpdate, IceSpring_Draw, IceSpring_Create, IceSpring_StageLoad, IceSpring_EditorDraw, IceSpring_EditorLoad,
                 IceSpring_Serialize);
    CreateObject(&ImageTrail, "ImageTrail", sizeof(EntityImageTrail), sizeof(ObjectImageTrail), ImageTrail_Update, ImageTrail_LateUpdate,
    ...
    CreateObject(&InvincibleStars, "InvincibleStars", sizeof(EntityInvincibleStars), sizeof(ObjectInvincibleStars), InvincibleStars_Update,
    ...
    CreateObject(&InvisibleBlock, "InvisibleBlock", sizeof(EntityInvisibleBlock), sizeof(ObjectInvisibleBlock), InvisibleBlock_Update,
    ...
    CreateObject(&ItemBox, "ItemBox", sizeof(EntityItemBox), sizeof(ObjectItemBox), ItemBox_Update, ItemBox_LateUpdate, ItemBox_StaticUpdate,
                 ItemBox_Draw, ItemBox_Create, ItemBox_StageLoad, ItemBox_EditorDraw, ItemBox_EditorLoad, ItemBox_Serialize);
    CreateObject(&Iwamodoki, "Iwamodoki", sizeof(EntityIwamodoki), sizeof(ObjectIwamodoki), Iwamodoki_Update, Iwamodoki_LateUpdate,
                 Iwamodoki_StaticUpdate, Iwamodoki_Draw, Iwamodoki_Create, Iwamodoki_StageLoad, Iwamodoki_EditorDraw, Iwamodoki_EditorLoad,
                 Iwamodoki_Serialize);
    CreateObject(&JacobsLadder, "JacobsLadder", sizeof(EntityJacobsLadder), sizeof(ObjectJacobsLadder), JacobsLadder_Update, JacobsLadder_LateUpdate,
    ...
    CreateObject(&Jawz, "Jawz", sizeof(EntityJawz), sizeof(ObjectJawz), Jawz_Update, Jawz_LateUpdate, Jawz_StaticUpdate, Jawz_Draw, Jawz_Create,
                 Jawz_StageLoad, Jawz_EditorDraw, Jawz_EditorLoad, Jawz_Serialize);
    CreateObject(&Jellygnite, "Jellygnite", sizeof(EntityJellygnite), sizeof(ObjectJellygnite), Jellygnite_Update, Jellygnite_LateUpdate,
    ...
    CreateObject(&JuggleSaw, "JuggleSaw", sizeof(EntityJuggleSaw), sizeof(ObjectJuggleSaw), JuggleSaw_Update, JuggleSaw_LateUpdate,
                 JuggleSaw_StaticUpdate, JuggleSaw_Draw, JuggleSaw_Create, JuggleSaw_StageLoad, JuggleSaw_EditorDraw, JuggleSaw_EditorLoad,
                 JuggleSaw_Serialize);
    CreateObject(&JunctionWheel, "JunctionWheel", sizeof(EntityJunctionWheel), sizeof(ObjectJunctionWheel), JunctionWheel_Update,
    ...
    CreateObject(&Kabasira, "Kabasira", sizeof(EntityKabasira), sizeof(ObjectKabasira), Kabasira_Update, Kabasira_LateUpdate, Kabasira_StaticUpdate,
                 Kabasira_Draw, Kabasira_Create, Kabasira_StageLoad, Kabasira_EditorDraw, Kabasira_EditorLoad, Kabasira_Serialize);
    CreateObject(&Kanabun, "Kanabun", sizeof(EntityKanabun), sizeof(ObjectKanabun), Kanabun_Update, Kanabun_LateUpdate, Kanabun_StaticUpdate,
                 Kanabun_Draw, Kanabun_Create, Kanabun_StageLoad, Kanabun_EditorDraw, Kanabun_EditorLoad, Kanabun_Serialize);
    CreateObject(&KingAttack, "KingAttack", sizeof(EntityKingAttack), sizeof(ObjectKingAttack), KingAttack_Update, KingAttack_LateUpdate,
    ...
    CreateObject(&KingClaw, "KingClaw", sizeof(EntityKingClaw), sizeof(ObjectKingClaw), KingClaw_Update, KingClaw_LateUpdate, KingClaw_StaticUpdate,
                 KingClaw_Draw, KingClaw_Create, KingClaw_StageLoad, KingClaw_EditorDraw, KingClaw_EditorLoad, KingClaw_Serialize);
    CreateObject(&KleptoMobile, "KleptoMobile", sizeof(EntityKleptoMobile), sizeof(ObjectKleptoMobile), KleptoMobile_Update, KleptoMobile_LateUpdate,
    ...
    CreateObject(&LargeGear, "LargeGear", sizeof(EntityLargeGear), sizeof(ObjectLargeGear), LargeGear_Update, LargeGear_LateUpdate,
                 LargeGear_StaticUpdate, LargeGear_Draw, LargeGear_Create, LargeGear_StageLoad, LargeGear_EditorDraw, LargeGear_EditorLoad,
                 LargeGear_Serialize);
    CreateObject(&Launcher, "Launcher", sizeof(EntityLauncher), sizeof(ObjectLauncher), Launcher_Update, Launcher_LateUpdate, Launcher_StaticUpdate,
                 Launcher_Draw, Launcher_Create, Launcher_StageLoad, Launcher_EditorDraw, Launcher_EditorLoad, Launcher_Serialize);
    CreateObject(&LaunchSpring, "LaunchSpring", sizeof(EntityLaunchSpring), sizeof(ObjectLaunchSpring), LaunchSpring_Update, LaunchSpring_LateUpdate,
    ...
    CreateObject(&LaundroMobile, "LaundroMobile", sizeof(EntityLaundroMobile), sizeof(ObjectLaundroMobile), LaundroMobile_Update,
    ...
    CreateObject(&LavaFall, "LavaFall", sizeof(EntityLavaFall), sizeof(ObjectLavaFall), LavaFall_Update, LavaFall_LateUpdate, LavaFall_StaticUpdate,
                 LavaFall_Draw, LavaFall_Create, LavaFall_StageLoad, LavaFall_EditorDraw, LavaFall_EditorLoad, LavaFall_Serialize);
    CreateObject(&LavaGeyser, "LavaGeyser", sizeof(EntityLavaGeyser), sizeof(ObjectLavaGeyser), LavaGeyser_Update, LavaGeyser_LateUpdate,
    ...
    CreateObject(&LEDPanel, "LEDPanel", sizeof(EntityLEDPanel), sizeof(ObjectLEDPanel), LEDPanel_Update, LEDPanel_LateUpdate, LEDPanel_StaticUpdate,
                 LEDPanel_Draw, LEDPanel_Create, LEDPanel_StageLoad, LEDPanel_EditorDraw, LEDPanel_EditorLoad, LEDPanel_Serialize);
    CreateObject(&Letterboard, "Letterboard", sizeof(EntityLetterboard), sizeof(ObjectLetterboard), Letterboard_Update, Letterboard_LateUpdate,
    ...
    CreateObject(&LevelSelect, "LevelSelect", sizeof(EntityLevelSelect), sizeof(ObjectLevelSelect), LevelSelect_Update, LevelSelect_LateUpdate,
    ...
    CreateObject(&LightBarrier, "LightBarrier", sizeof(EntityLightBarrier), sizeof(ObjectLightBarrier), LightBarrier_Update, LightBarrier_LateUpdate,
    ...
    CreateObject(&LightBulb, "LightBulb", sizeof(EntityLightBulb), sizeof(ObjectLightBulb), LightBulb_Update, LightBulb_LateUpdate,
                 LightBulb_StaticUpdate, LightBulb_Draw, LightBulb_Create, LightBulb_StageLoad, LightBulb_EditorDraw, LightBulb_EditorLoad,
                 LightBulb_Serialize);
    CreateObject(&Localization, "Localization", sizeof(EntityLocalization), sizeof(ObjectLocalization), Localization_Update, Localization_LateUpdate,
    ...
    CreateObject(&LocoSmoke, "LocoSmoke", sizeof(EntityLocoSmoke), sizeof(ObjectLocoSmoke), LocoSmoke_Update, LocoSmoke_LateUpdate,
                 LocoSmoke_StaticUpdate, LocoSmoke_Draw, LocoSmoke_Create, LocoSmoke_StageLoad, LocoSmoke_EditorDraw, LocoSmoke_EditorLoad,
                 LocoSmoke_Serialize);
    CreateObject(&LogoSetup, "LogoSetup", sizeof(EntityLogoSetup), sizeof(ObjectLogoSetup), LogoSetup_Update, LogoSetup_LateUpdate,
                 LogoSetup_StaticUpdate, LogoSetup_Draw, LogoSetup_Create, LogoSetup_StageLoad, LogoSetup_EditorDraw, LogoSetup_EditorLoad,
                 LogoSetup_Serialize);
    CreateObject(&LottoBall, "LottoBall", sizeof(EntityLottoBall), sizeof(ObjectLottoBall), LottoBall_Update, LottoBall_LateUpdate,
                 LottoBall_StaticUpdate, LottoBall_Draw, LottoBall_Create, LottoBall_StageLoad, LottoBall_EditorDraw, LottoBall_EditorLoad,
                 LottoBall_Serialize);
    CreateObject(&LottoMachine, "LottoMachine", sizeof(EntityLottoMachine), sizeof(ObjectLottoMachine), LottoMachine_Update, LottoMachine_LateUpdate,
    ...
    CreateObject(&LoveTester, "LoveTester", sizeof(EntityLoveTester), sizeof(ObjectLoveTester), LoveTester_Update, LoveTester_LateUpdate,
    ...
    CreateObject(&LRZ1Intro, "LRZ1Intro", sizeof(EntityLRZ1Intro), sizeof(ObjectLRZ1Intro), LRZ1Intro_Update, LRZ1Intro_LateUpdate,
                 LRZ1Intro_StaticUpdate, LRZ1Intro_Draw, LRZ1Intro_Create, LRZ1Intro_StageLoad, LRZ1Intro_EditorDraw, LRZ1Intro_EditorLoad,
                 LRZ1Intro_Serialize);
    CreateObject(&LRZ1Outro, "LRZ1Outro", sizeof(EntityLRZ1Outro), sizeof(ObjectLRZ1Outro), LRZ1Outro_Update, LRZ1Outro_LateUpdate,
                 LRZ1Outro_StaticUpdate, LRZ1Outro_Draw, LRZ1Outro_Create, LRZ1Outro_StageLoad, LRZ1Outro_EditorDraw, LRZ1Outro_EditorLoad,
                 LRZ1Outro_Serialize);
    CreateObject(&LRZ1Setup, "LRZ1Setup", sizeof(EntityLRZ1Setup), sizeof(ObjectLRZ1Setup), LRZ1Setup_Update, LRZ1Setup_LateUpdate,
                 LRZ1Setup_StaticUpdate, LRZ1Setup_Draw, LRZ1Setup_Create, LRZ1Setup_StageLoad, LRZ1Setup_EditorDraw, LRZ1Setup_EditorLoad,
                 LRZ1Setup_Serialize);
    CreateObject(&LRZ2Setup, "LRZ2Setup", sizeof(EntityLRZ2Setup), sizeof(ObjectLRZ2Setup), LRZ2Setup_Update, LRZ2Setup_LateUpdate,
                 LRZ2Setup_StaticUpdate, LRZ2Setup_Draw, LRZ2Setup_Create, LRZ2Setup_StageLoad, LRZ2Setup_EditorDraw, LRZ2Setup_EditorLoad,
                 LRZ2Setup_Serialize);
    CreateObject(&LRZ3Cutscene, "LRZ3Cutscene", sizeof(EntityLRZ3Cutscene), sizeof(ObjectLRZ3Cutscene), LRZ3Cutscene_Update, LRZ3Cutscene_LateUpdate,
    ...
    CreateObject(&LRZ3Outro, "LRZ3Outro", sizeof(EntityLRZ3Outro), sizeof(ObjectLRZ3Outro), LRZ3Outro_Update, LRZ3Outro_LateUpdate,
                 LRZ3Outro_StaticUpdate, LRZ3Outro_Draw, LRZ3Outro_Create, LRZ3Outro_StageLoad, LRZ3Outro_EditorDraw, LRZ3Outro_EditorLoad,
                 LRZ3Outro_Serialize);
    CreateObject(&LRZ3OutroK, "LRZ3OutroK", sizeof(EntityLRZ3OutroK), sizeof(ObjectLRZ3OutroK), LRZ3OutroK_Update, LRZ3OutroK_LateUpdate,
    ...
    CreateObject(&LRZ3Setup, "LRZ3Setup", sizeof(EntityLRZ3Setup), sizeof(ObjectLRZ3Setup), LRZ3Setup_Update, LRZ3Setup_LateUpdate,
                 LRZ3Setup_StaticUpdate, LRZ3Setup_Draw, LRZ3Setup_Create, LRZ3Setup_StageLoad, LRZ3Setup_EditorDraw, LRZ3Setup_EditorLoad,
                 LRZ3Setup_Serialize);
    CreateObject(&LRZConvControl, "LRZConvControl", sizeof(EntityLRZConvControl), sizeof(ObjectLRZConvControl), LRZConvControl_Update,
    ...
    CreateObject(&LRZConvDropper, "LRZConvDropper", sizeof(EntityLRZConvDropper), sizeof(ObjectLRZConvDropper), LRZConvDropper_Update,
    ...
    CreateObject(&LRZConveyor, "LRZConveyor", sizeof(EntityLRZConveyor), sizeof(ObjectLRZConveyor), LRZConveyor_Update, LRZConveyor_LateUpdate,
    ...
    CreateObject(&LRZConvItem, "LRZConvItem", sizeof(EntityLRZConvItem), sizeof(ObjectLRZConvItem), LRZConvItem_Update, LRZConvItem_LateUpdate,
    ...
    CreateObject(&LRZConvSwitch, "LRZConvSwitch", sizeof(EntityLRZConvSwitch), sizeof(ObjectLRZConvSwitch), LRZConvSwitch_Update,
    ...
    CreateObject(&LRZFireball, "LRZFireball", sizeof(EntityLRZFireball), sizeof(ObjectLRZFireball), LRZFireball_Update, LRZFireball_LateUpdate,
    ...
    CreateObject(&LRZRockPile, "LRZRockPile", sizeof(EntityLRZRockPile), sizeof(ObjectLRZRockPile), LRZRockPile_Update, LRZRockPile_LateUpdate,
    ...
    CreateObject(&LRZSpikeBall, "LRZSpikeBall", sizeof(EntityLRZSpikeBall), sizeof(ObjectLRZSpikeBall), LRZSpikeBall_Update, LRZSpikeBall_LateUpdate,
    ...
    CreateObject(&LRZSpiral, "LRZSpiral", sizeof(EntityLRZSpiral), sizeof(ObjectLRZSpiral), LRZSpiral_Update, LRZSpiral_LateUpdate,
                 LRZSpiral_StaticUpdate, LRZSpiral_Draw, LRZSpiral_Create, LRZSpiral_StageLoad, LRZSpiral_EditorDraw, LRZSpiral_EditorLoad,
                 LRZSpiral_Serialize);
    CreateObject(&MagnetSphere, "MagnetSphere", sizeof(EntityMagnetSphere), sizeof(ObjectMagnetSphere), MagnetSphere_Update, MagnetSphere_LateUpdate,
    ...
    CreateObject(&MagPlatform, "MagPlatform", sizeof(EntityMagPlatform), sizeof(ObjectMagPlatform), MagPlatform_Update, MagPlatform_LateUpdate,
    ...
    CreateObject(&MagSpikeBall, "MagSpikeBall", sizeof(EntityMagSpikeBall), sizeof(ObjectMagSpikeBall), MagSpikeBall_Update, MagSpikeBall_LateUpdate,
    ...
    CreateObject(&MainMenu, "MainMenu", sizeof(EntityMainMenu), sizeof(ObjectMainMenu), MainMenu_Update, MainMenu_LateUpdate, MainMenu_StaticUpdate,
                 MainMenu_Draw, MainMenu_Create, MainMenu_StageLoad, MainMenu_EditorDraw, MainMenu_EditorLoad, MainMenu_Serialize);
    CreateObject(&ManiaModeMenu, "ManiaModeMenu", sizeof(EntityManiaModeMenu), sizeof(ObjectManiaModeMenu), ManiaModeMenu_Update,
    ...
    CreateObject(&MatryoshkaBom, "MatryoshkaBom", sizeof(EntityMatryoshkaBom), sizeof(ObjectMatryoshkaBom), MatryoshkaBom_Update,
    ...
    CreateObject(&MechaBu, "MechaBu", sizeof(EntityMechaBu), sizeof(ObjectMechaBu), MechaBu_Update, MechaBu_LateUpdate, MechaBu_StaticUpdate,
                 MechaBu_Draw, MechaBu_Create, MechaBu_StageLoad, MechaBu_EditorDraw, MechaBu_EditorLoad, MechaBu_Serialize);
    CreateObject(&MegaChopper, "MegaChopper", sizeof(EntityMegaChopper), sizeof(ObjectMegaChopper), MegaChopper_Update, MegaChopper_LateUpdate,
    ...
    CreateObject(&MegaOctus, "MegaOctus", sizeof(EntityMegaOctus), sizeof(ObjectMegaOctus), MegaOctus_Update, MegaOctus_LateUpdate,
                 MegaOctus_StaticUpdate, MegaOctus_Draw, MegaOctus_Create, MegaOctus_StageLoad, MegaOctus_EditorDraw, MegaOctus_EditorLoad,
                 MegaOctus_Serialize);
    CreateObject(&MenuParam, "MenuParam", sizeof(EntityMenuParam), sizeof(ObjectMenuParam), MenuParam_Update, MenuParam_LateUpdate,
                 MenuParam_StaticUpdate, MenuParam_Draw, MenuParam_Create, MenuParam_StageLoad, MenuParam_EditorDraw, MenuParam_EditorLoad,
                 MenuParam_Serialize);
    CreateObject(&MenuSetup, "MenuSetup", sizeof(EntityMenuSetup), sizeof(ObjectMenuSetup), MenuSetup_Update, MenuSetup_LateUpdate,
                 MenuSetup_StaticUpdate, MenuSetup_Draw, MenuSetup_Create, MenuSetup_StageLoad, MenuSetup_EditorDraw, MenuSetup_EditorLoad,
                 MenuSetup_Serialize);
    CreateObject(&MetalArm, "MetalArm", sizeof(EntityMetalArm), sizeof(ObjectMetalArm), MetalArm_Update, MetalArm_LateUpdate, MetalArm_StaticUpdate,
                 MetalArm_Draw, MetalArm_Create, MetalArm_StageLoad, MetalArm_EditorDraw, MetalArm_EditorLoad, MetalArm_Serialize);
    CreateObject(&MetalSonic, "MetalSonic", sizeof(EntityMetalSonic), sizeof(ObjectMetalSonic), MetalSonic_Update, MetalSonic_LateUpdate,
    ...
    CreateObject(&MeterDroid, "MeterDroid", sizeof(EntityMeterDroid), sizeof(ObjectMeterDroid), MeterDroid_Update, MeterDroid_LateUpdate,
    ...
    CreateObject(&MicDrop, "MicDrop", sizeof(EntityMicDrop), sizeof(ObjectMicDrop), MicDrop_Update, MicDrop_LateUpdate, MicDrop_StaticUpdate,
                 MicDrop_Draw, MicDrop_Create, MicDrop_StageLoad, MicDrop_EditorDraw, MicDrop_EditorLoad, MicDrop_Serialize);
    CreateObject(&Mine, "Mine", sizeof(EntityMine), sizeof(ObjectMine), Mine_Update, Mine_LateUpdate, Mine_StaticUpdate, Mine_Draw, Mine_Create,
                 Mine_StageLoad, Mine_EditorDraw, Mine_EditorLoad, Mine_Serialize);
    CreateObject(&MMZ2Outro, "MMZ2Outro", sizeof(EntityMMZ2Outro), sizeof(ObjectMMZ2Outro), MMZ2Outro_Update, MMZ2Outro_LateUpdate,
                 MMZ2Outro_StaticUpdate, MMZ2Outro_Draw, MMZ2Outro_Create, MMZ2Outro_StageLoad, MMZ2Outro_EditorDraw, MMZ2Outro_EditorLoad,
                 MMZ2Outro_Serialize);
    CreateObject(&MMZLightning, "MMZLightning", sizeof(EntityMMZLightning), sizeof(ObjectMMZLightning), MMZLightning_Update, MMZLightning_LateUpdate,
    ...
    CreateObject(&MMZSetup, "MMZSetup", sizeof(EntityMMZSetup), sizeof(ObjectMMZSetup), MMZSetup_Update, MMZSetup_LateUpdate, MMZSetup_StaticUpdate,
                 MMZSetup_Draw, MMZSetup_Create, MMZSetup_StageLoad, MMZSetup_EditorDraw, MMZSetup_EditorLoad, MMZSetup_Serialize);
    CreateObject(&MMZWheel, "MMZWheel", sizeof(EntityMMZWheel), sizeof(ObjectMMZWheel), MMZWheel_Update, MMZWheel_LateUpdate, MMZWheel_StaticUpdate,
                 MMZWheel_Draw, MMZWheel_Create, MMZWheel_StageLoad, MMZWheel_EditorDraw, MMZWheel_EditorLoad, MMZWheel_Serialize);
    CreateObject(&MonarchBG, "MonarchBG", sizeof(EntityMonarchBG), sizeof(ObjectMonarchBG), MonarchBG_Update, MonarchBG_LateUpdate,
                 MonarchBG_StaticUpdate, MonarchBG_Draw, MonarchBG_Create, MonarchBG_StageLoad, MonarchBG_EditorDraw, MonarchBG_EditorLoad,
                 MonarchBG_Serialize);
    CreateObject(&MonarchPlans, "MonarchPlans", sizeof(EntityMonarchPlans), sizeof(ObjectMonarchPlans), MonarchPlans_Update, MonarchPlans_LateUpdate,
    ...
    CreateObject(&MonkeyDude, "MonkeyDude", sizeof(EntityMonkeyDude), sizeof(ObjectMonkeyDude), MonkeyDude_Update, MonkeyDude_LateUpdate,
    ...
    CreateObject(&Motobug, "Motobug", sizeof(EntityMotobug), sizeof(ObjectMotobug), Motobug_Update, Motobug_LateUpdate, Motobug_StaticUpdate,
                 Motobug_Draw, Motobug_Create, Motobug_StageLoad, Motobug_EditorDraw, Motobug_EditorLoad, Motobug_Serialize);
    CreateObject(&MSBomb, "MSBomb", sizeof(EntityMSBomb), sizeof(ObjectMSBomb), MSBomb_Update, MSBomb_LateUpdate, MSBomb_StaticUpdate, MSBomb_Draw,
                 MSBomb_Create, MSBomb_StageLoad, MSBomb_EditorDraw, MSBomb_EditorLoad, MSBomb_Serialize);
    CreateObject(&MSFactory, "MSFactory", sizeof(EntityMSFactory), sizeof(ObjectMSFactory), MSFactory_Update, MSFactory_LateUpdate,
                 MSFactory_StaticUpdate, MSFactory_Draw, MSFactory_Create, MSFactory_StageLoad, MSFactory_EditorDraw, MSFactory_EditorLoad,
                 MSFactory_Serialize);
    CreateObject(&MSHologram, "MSHologram", sizeof(EntityMSHologram), sizeof(ObjectMSHologram), MSHologram_Update, MSHologram_LateUpdate,
    ...
    CreateObject(&MSOrb, "MSOrb", sizeof(EntityMSOrb), sizeof(ObjectMSOrb), MSOrb_Update, MSOrb_LateUpdate, MSOrb_StaticUpdate, MSOrb_Draw,
                 MSOrb_Create, MSOrb_StageLoad, MSOrb_EditorDraw, MSOrb_EditorLoad, MSOrb_Serialize);
    CreateObject(&MSPanel, "MSPanel", sizeof(EntityMSPanel), sizeof(ObjectMSPanel), MSPanel_Update, MSPanel_LateUpdate, MSPanel_StaticUpdate,
                 MSPanel_Draw, MSPanel_Create, MSPanel_StageLoad, MSPanel_EditorDraw, MSPanel_EditorLoad, MSPanel_Serialize);
    CreateObject(&MSZ1KIntro, "MSZ1KIntro", sizeof(EntityMSZ1KIntro), sizeof(ObjectMSZ1KIntro), MSZ1KIntro_Update, MSZ1KIntro_LateUpdate,
    ...
    CreateObject(&MSZ2Cutscene, "MSZ2Cutscene", sizeof(EntityMSZ2Cutscene), sizeof(ObjectMSZ2Cutscene), MSZ2Cutscene_Update, MSZ2Cutscene_LateUpdate,
    ...
    CreateObject(&MSZCutsceneK, "MSZCutsceneK", sizeof(EntityMSZCutsceneK), sizeof(ObjectMSZCutsceneK), MSZCutsceneK_Update, MSZCutsceneK_LateUpdate,
    ...
    CreateObject(&MSZCutsceneST, "MSZCutsceneST", sizeof(EntityMSZCutsceneST), sizeof(ObjectMSZCutsceneST), MSZCutsceneST_Update,
    ...
    CreateObject(&MSZSetup, "MSZSetup", sizeof(EntityMSZSetup), sizeof(ObjectMSZSetup), MSZSetup_Update, MSZSetup_LateUpdate, MSZSetup_StaticUpdate,
                 MSZSetup_Draw, MSZSetup_Create, MSZSetup_StageLoad, MSZSetup_EditorDraw, MSZSetup_EditorLoad, MSZSetup_Serialize);
    CreateObject(&MSZSpotlight, "MSZSpotlight", sizeof(EntityMSZSpotlight), sizeof(ObjectMSZSpotlight), MSZSpotlight_Update, MSZSpotlight_LateUpdate,
    ...
    CreateObject(&Music, "Music", sizeof(EntityMusic), sizeof(ObjectMusic), Music_Update, Music_LateUpdate, Music_StaticUpdate, Music_Draw,
                 Music_Create, Music_StageLoad, Music_EditorDraw, Music_EditorLoad, Music_Serialize);
    CreateObject(&Newspaper, "Newspaper", sizeof(EntityNewspaper), sizeof(ObjectNewspaper), Newspaper_Update, Newspaper_LateUpdate,
                 Newspaper_StaticUpdate, Newspaper_Draw, Newspaper_Create, Newspaper_StageLoad, Newspaper_EditorDraw, Newspaper_EditorLoad,
                 Newspaper_Serialize);
    CreateObject(&Newtron, "Newtron", sizeof(EntityNewtron), sizeof(ObjectNewtron), Newtron_Update, Newtron_LateUpdate, Newtron_StaticUpdate,
                 Newtron_Draw, Newtron_Create, Newtron_StageLoad, Newtron_EditorDraw, Newtron_EditorLoad, Newtron_Serialize);
    CreateObject(&NoSwap, "NoSwap", sizeof(EntityNoSwap), sizeof(ObjectNoSwap), NoSwap_Update, NoSwap_LateUpdate, NoSwap_StaticUpdate, NoSwap_Draw,
                 NoSwap_Create, NoSwap_StageLoad, NoSwap_EditorDraw, NoSwap_EditorLoad, NoSwap_Serialize);
    CreateObject(&Octus, "Octus", sizeof(EntityOctus), sizeof(ObjectOctus), Octus_Update, Octus_LateUpdate, Octus_StaticUpdate, Octus_Draw,
                 Octus_Create, Octus_StageLoad, Octus_EditorDraw, Octus_EditorLoad, Octus_Serialize);
    CreateObject(&OneWayDoor, "OneWayDoor", sizeof(EntityOneWayDoor), sizeof(ObjectOneWayDoor), OneWayDoor_Update, OneWayDoor_LateUpdate,
    ...
    CreateObject(&OOZ1Outro, "OOZ1Outro", sizeof(EntityOOZ1Outro), sizeof(ObjectOOZ1Outro), OOZ1Outro_Update, OOZ1Outro_LateUpdate,
                 OOZ1Outro_StaticUpdate, OOZ1Outro_Draw, OOZ1Outro_Create, OOZ1Outro_StageLoad, OOZ1Outro_EditorDraw, OOZ1Outro_EditorLoad,
                 OOZ1Outro_Serialize);
    CreateObject(&OOZ2Outro, "OOZ2Outro", sizeof(EntityOOZ2Outro), sizeof(ObjectOOZ2Outro), OOZ2Outro_Update, OOZ2Outro_LateUpdate,
                 OOZ2Outro_StaticUpdate, OOZ2Outro_Draw, OOZ2Outro_Create, OOZ2Outro_StageLoad, OOZ2Outro_EditorDraw, OOZ2Outro_EditorLoad,
                 OOZ2Outro_Serialize);
    CreateObject(&OOZFlames, "OOZFlames", sizeof(EntityOOZFlames), sizeof(ObjectOOZFlames), OOZFlames_Update, OOZFlames_LateUpdate,
                 OOZFlames_StaticUpdate, OOZFlames_Draw, OOZFlames_Create, OOZFlames_StageLoad, OOZFlames_EditorDraw, OOZFlames_EditorLoad,
                 OOZFlames_Serialize);
    CreateObject(&OOZSetup, "OOZSetup", sizeof(EntityOOZSetup), sizeof(ObjectOOZSetup), OOZSetup_Update, OOZSetup_LateUpdate, OOZSetup_StaticUpdate,
                 OOZSetup_Draw, OOZSetup_Create, OOZSetup_StageLoad, OOZSetup_EditorDraw, OOZSetup_EditorLoad, OOZSetup_Serialize);
    CreateObject(&OptionsMenu, "OptionsMenu", sizeof(EntityOptionsMenu), sizeof(ObjectOptionsMenu), OptionsMenu_Update, OptionsMenu_LateUpdate,
    ...
    CreateObject(&OrbitSpike, "OrbitSpike", sizeof(EntityOrbitSpike), sizeof(ObjectOrbitSpike), OrbitSpike_Update, OrbitSpike_LateUpdate,
    ...
    CreateObject(&PaintingEyes, "PaintingEyes", sizeof(EntityPaintingEyes), sizeof(ObjectPaintingEyes), PaintingEyes_Update, PaintingEyes_LateUpdate,
    ...
    CreateObject(&PaperRoller, "PaperRoller", sizeof(EntityPaperRoller), sizeof(ObjectPaperRoller), PaperRoller_Update, PaperRoller_LateUpdate,
    ...
    CreateObject(&ParallaxSprite, "ParallaxSprite", sizeof(EntityParallaxSprite), sizeof(ObjectParallaxSprite), ParallaxSprite_Update,
    ...
    CreateObject(&PathInverter, "PathInverter", sizeof(EntityPathInverter), sizeof(ObjectPathInverter), PathInverter_Update, PathInverter_LateUpdate,
    ...
    CreateObject(&PauseMenu, "PauseMenu", sizeof(EntityPauseMenu), sizeof(ObjectPauseMenu), PauseMenu_Update, PauseMenu_LateUpdate,
                 PauseMenu_StaticUpdate, PauseMenu_Draw, PauseMenu_Create, PauseMenu_StageLoad, PauseMenu_EditorDraw, PauseMenu_EditorLoad,
                 PauseMenu_Serialize);
    CreateObject(&PBL_Bumper, "PBL_Bumper", sizeof(EntityPBL_Bumper), sizeof(ObjectPBL_Bumper), PBL_Bumper_Update, PBL_Bumper_LateUpdate,
    ...
    CreateObject(&PBL_Camera, "PBL_Camera", sizeof(EntityPBL_Camera), sizeof(ObjectPBL_Camera), PBL_Camera_Update, PBL_Camera_LateUpdate,
    ...
    CreateObject(&PBL_Crane, "PBL_Crane", sizeof(EntityPBL_Crane), sizeof(ObjectPBL_Crane), PBL_Crane_Update, PBL_Crane_LateUpdate,
                 PBL_Crane_StaticUpdate, PBL_Crane_Draw, PBL_Crane_Create, PBL_Crane_StageLoad, PBL_Crane_EditorDraw, PBL_Crane_EditorLoad,
                 PBL_Crane_Serialize);
    CreateObject(&PBL_Flipper, "PBL_Flipper", sizeof(EntityPBL_Flipper), sizeof(ObjectPBL_Flipper), PBL_Flipper_Update, PBL_Flipper_LateUpdate,
    ...
    CreateObject(&PBL_HUD, "PBL_HUD", sizeof(EntityPBL_HUD), sizeof(ObjectPBL_HUD), PBL_HUD_Update, PBL_HUD_LateUpdate, PBL_HUD_StaticUpdate,
                 PBL_HUD_Draw, PBL_HUD_Create, PBL_HUD_StageLoad, PBL_HUD_EditorDraw, PBL_HUD_EditorLoad, PBL_HUD_Serialize);
    CreateObject(&PBL_Player, "PBL_Player", sizeof(EntityPBL_Player), sizeof(ObjectPBL_Player), PBL_Player_Update, PBL_Player_LateUpdate,
    ...
    CreateObject(&PBL_Ring, "PBL_Ring", sizeof(EntityPBL_Ring), sizeof(ObjectPBL_Ring), PBL_Ring_Update, PBL_Ring_LateUpdate, PBL_Ring_StaticUpdate,
                 PBL_Ring_Draw, PBL_Ring_Create, PBL_Ring_StageLoad, PBL_Ring_EditorDraw, PBL_Ring_EditorLoad, PBL_Ring_Serialize);
    CreateObject(&PBL_Sector, "PBL_Sector", sizeof(EntityPBL_Sector), sizeof(ObjectPBL_Sector), PBL_Sector_Update, PBL_Sector_LateUpdate,
    ...
    CreateObject(&PBL_Setup, "PBL_Setup", sizeof(EntityPBL_Setup), sizeof(ObjectPBL_Setup), PBL_Setup_Update, PBL_Setup_LateUpdate,
                 PBL_Setup_StaticUpdate, PBL_Setup_Draw, PBL_Setup_Create, PBL_Setup_StageLoad, PBL_Setup_EditorDraw, PBL_Setup_EditorLoad,
                 PBL_Setup_Serialize);
    CreateObject(&PBL_TargetBumper, "PBL_TargetBumper", sizeof(EntityPBL_TargetBumper), sizeof(ObjectPBL_TargetBumper), PBL_TargetBumper_Update,
    ...
    CreateObject(&PetalPile, "PetalPile", sizeof(EntityPetalPile), sizeof(ObjectPetalPile), PetalPile_Update, PetalPile_LateUpdate,
                 PetalPile_StaticUpdate, PetalPile_Draw, PetalPile_Create, PetalPile_StageLoad, PetalPile_EditorDraw, PetalPile_EditorLoad,
                 PetalPile_Serialize);
    CreateObject(&PhantomEgg, "PhantomEgg", sizeof(EntityPhantomEgg), sizeof(ObjectPhantomEgg), PhantomEgg_Update, PhantomEgg_LateUpdate,
    ...
    CreateObject(&PhantomGunner, "PhantomGunner", sizeof(EntityPhantomGunner), sizeof(ObjectPhantomGunner), PhantomGunner_Update,
    ...
    CreateObject(&PhantomHand, "PhantomHand", sizeof(EntityPhantomHand), sizeof(ObjectPhantomHand), PhantomHand_Update, PhantomHand_LateUpdate,
    ...
    CreateObject(&PhantomKing, "PhantomKing", sizeof(EntityPhantomKing), sizeof(ObjectPhantomKing), PhantomKing_Update, PhantomKing_LateUpdate,
    ...
    CreateObject(&PhantomMissile, "PhantomMissile", sizeof(EntityPhantomMissile), sizeof(ObjectPhantomMissile), PhantomMissile_Update,
    ...
    CreateObject(&PhantomMystic, "PhantomMystic", sizeof(EntityPhantomMystic), sizeof(ObjectPhantomMystic), PhantomMystic_Update,
    ...
    CreateObject(&PhantomRider, "PhantomRider", sizeof(EntityPhantomRider), sizeof(ObjectPhantomRider), PhantomRider_Update, PhantomRider_LateUpdate,
    ...
    CreateObject(&PhantomRuby, "PhantomRuby", sizeof(EntityPhantomRuby), sizeof(ObjectPhantomRuby), PhantomRuby_Update, PhantomRuby_LateUpdate,
    ...
    CreateObject(&PhantomShield, "PhantomShield", sizeof(EntityPhantomShield), sizeof(ObjectPhantomShield), PhantomShield_Update,
    ...
    CreateObject(&PhantomShinobi, "PhantomShinobi", sizeof(EntityPhantomShinobi), sizeof(ObjectPhantomShinobi), PhantomShinobi_Update,
    ...
    CreateObject(&PimPom, "PimPom", sizeof(EntityPimPom), sizeof(ObjectPimPom), PimPom_Update, PimPom_LateUpdate, PimPom_StaticUpdate, PimPom_Draw,
                 PimPom_Create, PimPom_StageLoad, PimPom_EditorDraw, PimPom_EditorLoad, PimPom_Serialize);
    CreateObject(&Pinata, "Pinata", sizeof(EntityPinata), sizeof(ObjectPinata), Pinata_Update, Pinata_LateUpdate, Pinata_StaticUpdate, Pinata_Draw,
                 Pinata_Create, Pinata_StageLoad, Pinata_EditorDraw, Pinata_EditorLoad, Pinata_Serialize);
    CreateObject(&Piston, "Piston", sizeof(EntityPiston), sizeof(ObjectPiston), Piston_Update, Piston_LateUpdate, Piston_StaticUpdate, Piston_Draw,
                 Piston_Create, Piston_StageLoad, Piston_EditorDraw, Piston_EditorLoad, Piston_Serialize);
    CreateObject(&PKingAttack, "PKingAttack", sizeof(EntityPKingAttack), sizeof(ObjectPKingAttack), PKingAttack_Update, PKingAttack_LateUpdate,
    ...
    CreateObject(&PlaneSeeSaw, "PlaneSeeSaw", sizeof(EntityPlaneSeeSaw), sizeof(ObjectPlaneSeeSaw), PlaneSeeSaw_Update, PlaneSeeSaw_LateUpdate,
    ...
    CreateObject(&PlaneSwitch, "PlaneSwitch", sizeof(EntityPlaneSwitch), sizeof(ObjectPlaneSwitch), PlaneSwitch_Update, PlaneSwitch_LateUpdate,
    ...
    CreateObject(&Platform, "Platform", sizeof(EntityPlatform), sizeof(ObjectPlatform), Platform_Update, Platform_LateUpdate, Platform_StaticUpdate,
                 Platform_Draw, Platform_Create, Platform_StageLoad, Platform_EditorDraw, Platform_EditorLoad, Platform_Serialize);
    CreateObject(&PlatformControl, "PlatformControl", sizeof(EntityPlatformControl), sizeof(ObjectPlatformControl), PlatformControl_Update,
    ...
    CreateObject(&PlatformNode, "PlatformNode", sizeof(EntityPlatformNode), sizeof(ObjectPlatformNode), PlatformNode_Update, PlatformNode_LateUpdate,
    ...
    CreateObject(&Player, "Player", sizeof(EntityPlayer), sizeof(ObjectPlayer), Player_Update, Player_LateUpdate, Player_StaticUpdate, Player_Draw,
                 Player_Create, Player_StageLoad, Player_EditorDraw, Player_EditorLoad, Player_Serialize);
    CreateObject(&PlayerProbe, "PlayerProbe", sizeof(EntityPlayerProbe), sizeof(ObjectPlayerProbe), PlayerProbe_Update, PlayerProbe_LateUpdate,
    ...
    CreateObject(&PohBee, "PohBee", sizeof(EntityPohBee), sizeof(ObjectPohBee), PohBee_Update, PohBee_LateUpdate, PohBee_StaticUpdate, PohBee_Draw,
                 PohBee_Create, PohBee_StageLoad, PohBee_EditorDraw, PohBee_EditorLoad, PohBee_Serialize);
    CreateObject(&Pointdexter, "Pointdexter", sizeof(EntityPointdexter), sizeof(ObjectPointdexter), Pointdexter_Update, Pointdexter_LateUpdate,
    ...
    CreateObject(&PopcornKernel, "PopcornKernel", sizeof(EntityPopcornKernel), sizeof(ObjectPopcornKernel), PopcornKernel_Update,
    ...
    CreateObject(&PopcornMachine, "PopcornMachine", sizeof(EntityPopcornMachine), sizeof(ObjectPopcornMachine), PopcornMachine_Update,
    ...
    CreateObject(&PopOut, "PopOut", sizeof(EntityPopOut), sizeof(ObjectPopOut), PopOut_Update, PopOut_LateUpdate, PopOut_StaticUpdate, PopOut_Draw,
                 PopOut_Create, PopOut_StageLoad, PopOut_EditorDraw, PopOut_EditorLoad, PopOut_Serialize);
    CreateObject(&Press, "Press", sizeof(EntityPress), sizeof(ObjectPress), Press_Update, Press_LateUpdate, Press_StaticUpdate, Press_Draw,
                 Press_Create, Press_StageLoad, Press_EditorDraw, Press_EditorLoad, Press_Serialize);
    CreateObject(&PrintBlock, "PrintBlock", sizeof(EntityPrintBlock), sizeof(ObjectPrintBlock), PrintBlock_Update, PrintBlock_LateUpdate,
    ...
    CreateObject(&Projectile, "Projectile", sizeof(EntityProjectile), sizeof(ObjectProjectile), Projectile_Update, Projectile_LateUpdate,
    ...
    CreateObject(&Propeller, "Propeller", sizeof(EntityPropeller), sizeof(ObjectPropeller), Propeller_Update, Propeller_LateUpdate,
                 Propeller_StaticUpdate, Propeller_Draw, Propeller_Create, Propeller_StageLoad, Propeller_EditorDraw, Propeller_EditorLoad,
                 Propeller_Serialize);
    CreateObject(&PropellerShaft, "PropellerShaft", sizeof(EntityPropellerShaft), sizeof(ObjectPropellerShaft), PropellerShaft_Update,
    ...
    CreateObject(&PSZ1Intro, "PSZ1Intro", sizeof(EntityPSZ1Intro), sizeof(ObjectPSZ1Intro), PSZ1Intro_Update, PSZ1Intro_LateUpdate,
                 PSZ1Intro_StaticUpdate, PSZ1Intro_Draw, PSZ1Intro_Create, PSZ1Intro_StageLoad, PSZ1Intro_EditorDraw, PSZ1Intro_EditorLoad,
                 PSZ1Intro_Serialize);
    CreateObject(&PSZ1Setup, "PSZ1Setup", sizeof(EntityPSZ1Setup), sizeof(ObjectPSZ1Setup), PSZ1Setup_Update, PSZ1Setup_LateUpdate,
                 PSZ1Setup_StaticUpdate, PSZ1Setup_Draw, PSZ1Setup_Create, PSZ1Setup_StageLoad, PSZ1Setup_EditorDraw, PSZ1Setup_EditorLoad,
                 PSZ1Setup_Serialize);
    CreateObject(&PSZ2Intro, "PSZ2Intro", sizeof(EntityPSZ2Intro), sizeof(ObjectPSZ2Intro), PSZ2Intro_Update, PSZ2Intro_LateUpdate,
                 PSZ2Intro_StaticUpdate, PSZ2Intro_Draw, PSZ2Intro_Create, PSZ2Intro_StageLoad, PSZ2Intro_EditorDraw, PSZ2Intro_EditorLoad,
                 PSZ2Intro_Serialize);
    CreateObject(&PSZ2Outro, "PSZ2Outro", sizeof(EntityPSZ2Outro), sizeof(ObjectPSZ2Outro), PSZ2Outro_Update, PSZ2Outro_LateUpdate,
                 PSZ2Outro_StaticUpdate, PSZ2Outro_Draw, PSZ2Outro_Create, PSZ2Outro_StageLoad, PSZ2Outro_EditorDraw, PSZ2Outro_EditorLoad,
                 PSZ2Outro_Serialize);
    CreateObject(&PSZ2Setup, "PSZ2Setup", sizeof(EntityPSZ2Setup), sizeof(ObjectPSZ2Setup), PSZ2Setup_Update, PSZ2Setup_LateUpdate,
                 PSZ2Setup_StaticUpdate, PSZ2Setup_Draw, PSZ2Setup_Create, PSZ2Setup_StageLoad, PSZ2Setup_EditorDraw, PSZ2Setup_EditorLoad,
                 PSZ2Setup_Serialize);
    CreateObject(&PSZDoor, "PSZDoor", sizeof(EntityPSZDoor), sizeof(ObjectPSZDoor), PSZDoor_Update, PSZDoor_LateUpdate, PSZDoor_StaticUpdate,
                 PSZDoor_Draw, PSZDoor_Create, PSZDoor_StageLoad, PSZDoor_EditorDraw, PSZDoor_EditorLoad, PSZDoor_Serialize);
    CreateObject(&PSZEggman, "PSZEggman", sizeof(EntityPSZEggman), sizeof(ObjectPSZEggman), PSZEggman_Update, PSZEggman_LateUpdate,
                 PSZEggman_StaticUpdate, PSZEggman_Draw, PSZEggman_Create, PSZEggman_StageLoad, PSZEggman_EditorDraw, PSZEggman_EditorLoad,
                 PSZEggman_Serialize);
    CreateObject(&PSZLauncher, "PSZLauncher", sizeof(EntityPSZLauncher), sizeof(ObjectPSZLauncher), PSZLauncher_Update, PSZLauncher_LateUpdate,
    ...
    CreateObject(&PullChain, "PullChain", sizeof(EntityPullChain), sizeof(ObjectPullChain), PullChain_Update, PullChain_LateUpdate,
                 PullChain_StaticUpdate, PullChain_Draw, PullChain_Create, PullChain_StageLoad, PullChain_EditorDraw, PullChain_EditorLoad,
                 PullChain_Serialize);
    CreateObject(&PullSwitch, "PullSwitch", sizeof(EntityPullSwitch), sizeof(ObjectPullSwitch), PullSwitch_Update, PullSwitch_LateUpdate,
    ...
    CreateObject(&PushSpring, "PushSpring", sizeof(EntityPushSpring), sizeof(ObjectPushSpring), PushSpring_Update, PushSpring_LateUpdate,
    ...
    CreateObject(&PuyoAI, "PuyoAI", sizeof(EntityPuyoAI), sizeof(ObjectPuyoAI), PuyoAI_Update, PuyoAI_LateUpdate, PuyoAI_StaticUpdate, PuyoAI_Draw,
                 PuyoAI_Create, PuyoAI_StageLoad, PuyoAI_EditorDraw, PuyoAI_EditorLoad, PuyoAI_Serialize);
    CreateObject(&PuyoAttack, "PuyoAttack", sizeof(EntityPuyoAttack), sizeof(ObjectPuyoAttack), PuyoAttack_Update, PuyoAttack_LateUpdate,
    ...
    CreateObject(&PuyoBean, "PuyoBean", sizeof(EntityPuyoBean), sizeof(ObjectPuyoBean), PuyoBean_Update, PuyoBean_LateUpdate, PuyoBean_StaticUpdate,
                 PuyoBean_Draw, PuyoBean_Create, PuyoBean_StageLoad, PuyoBean_EditorDraw, PuyoBean_EditorLoad, PuyoBean_Serialize);
    CreateObject(&PuyoGame, "PuyoGame", sizeof(EntityPuyoGame), sizeof(ObjectPuyoGame), PuyoGame_Update, PuyoGame_LateUpdate, PuyoGame_StaticUpdate,
                 PuyoGame_Draw, PuyoGame_Create, PuyoGame_StageLoad, PuyoGame_EditorDraw, PuyoGame_EditorLoad, PuyoGame_Serialize);
    CreateObject(&PuyoIndicator, "PuyoIndicator", sizeof(EntityPuyoIndicator), sizeof(ObjectPuyoIndicator), PuyoIndicator_Update,
    ...
    CreateObject(&PuyoLabel, "PuyoLabel", sizeof(EntityPuyoLabel), sizeof(ObjectPuyoLabel), PuyoLabel_Update, PuyoLabel_LateUpdate,
                 PuyoLabel_StaticUpdate, PuyoLabel_Draw, PuyoLabel_Create, PuyoLabel_StageLoad, PuyoLabel_EditorDraw, PuyoLabel_EditorLoad,
                 PuyoLabel_Serialize);
    CreateObject(&PuyoLevelSelect, "PuyoLevelSelect", sizeof(EntityPuyoLevelSelect), sizeof(ObjectPuyoLevelSelect), PuyoLevelSelect_Update,
    ...
    CreateObject(&PuyoMatch, "PuyoMatch", sizeof(EntityPuyoMatch), sizeof(ObjectPuyoMatch), PuyoMatch_Update, PuyoMatch_LateUpdate,
                 PuyoMatch_StaticUpdate, PuyoMatch_Draw, PuyoMatch_Create, PuyoMatch_StageLoad, PuyoMatch_EditorDraw, PuyoMatch_EditorLoad,
                 PuyoMatch_Serialize);
    CreateObject(&PuyoScore, "PuyoScore", sizeof(EntityPuyoScore), sizeof(ObjectPuyoScore), PuyoScore_Update, PuyoScore_LateUpdate,
                 PuyoScore_StaticUpdate, PuyoScore_Draw, PuyoScore_Create, PuyoScore_StageLoad, PuyoScore_EditorDraw, PuyoScore_EditorLoad,
                 PuyoScore_Serialize);
    CreateObject(&Rattlekiller, "Rattlekiller", sizeof(EntityRattlekiller), sizeof(ObjectRattlekiller), Rattlekiller_Update, Rattlekiller_LateUpdate,
    ...
    CreateObject(&Reagent, "Reagent", sizeof(EntityReagent), sizeof(ObjectReagent), Reagent_Update, Reagent_LateUpdate, Reagent_StaticUpdate,
                 Reagent_Draw, Reagent_Create, Reagent_StageLoad, Reagent_EditorDraw, Reagent_EditorLoad, Reagent_Serialize);
    CreateObject(&ReplayDB, "ReplayDB", sizeof(EntityReplayDB), sizeof(ObjectReplayDB), ReplayDB_Update, ReplayDB_LateUpdate, ReplayDB_StaticUpdate,
                 ReplayDB_Draw, ReplayDB_Create, ReplayDB_StageLoad, ReplayDB_EditorDraw, ReplayDB_EditorLoad, ReplayDB_Serialize);
    CreateObject(&ReplayRecorder, "ReplayRecorder", sizeof(EntityReplayRecorder), sizeof(ObjectReplayRecorder), ReplayRecorder_Update,
    ...
    CreateObject(&Rexon, "Rexon", sizeof(EntityRexon), sizeof(ObjectRexon), Rexon_Update, Rexon_LateUpdate, Rexon_StaticUpdate, Rexon_Draw,
                 Rexon_Create, Rexon_StageLoad, Rexon_EditorDraw, Rexon_EditorLoad, Rexon_Serialize);
    CreateObject(&Rhinobot, "Rhinobot", sizeof(EntityRhinobot), sizeof(ObjectRhinobot), Rhinobot_Update, Rhinobot_LateUpdate, Rhinobot_StaticUpdate,
                 Rhinobot_Draw, Rhinobot_Create, Rhinobot_StageLoad, Rhinobot_EditorDraw, Rhinobot_EditorLoad, Rhinobot_Serialize);
    CreateObject(&Ring, "Ring", sizeof(EntityRing), sizeof(ObjectRing), Ring_Update, Ring_LateUpdate, Ring_StaticUpdate, Ring_Draw, Ring_Create,
                 Ring_StageLoad, Ring_EditorDraw, Ring_EditorLoad, Ring_Serialize);
    CreateObject(&RingField, "RingField", sizeof(EntityRingField), sizeof(ObjectRingField), RingField_Update, RingField_LateUpdate,
                 RingField_StaticUpdate, RingField_Draw, RingField_Create, RingField_StageLoad, RingField_EditorDraw, RingField_EditorLoad,
                 RingField_Serialize);
    CreateObject(&RisingLava, "RisingLava", sizeof(EntityRisingLava), sizeof(ObjectRisingLava), RisingLava_Update, RisingLava_LateUpdate,
    ...
    CreateObject(&RockDrill, "RockDrill", sizeof(EntityRockDrill), sizeof(ObjectRockDrill), RockDrill_Update, RockDrill_LateUpdate,
                 RockDrill_StaticUpdate, RockDrill_Draw, RockDrill_Create, RockDrill_StageLoad, RockDrill_EditorDraw, RockDrill_EditorLoad,
                 RockDrill_Serialize);
    CreateObject(&RockemSockem, "RockemSockem", sizeof(EntityRockemSockem), sizeof(ObjectRockemSockem), RockemSockem_Update, RockemSockem_LateUpdate,
    ...
    CreateObject(&RollerMKII, "RollerMKII", sizeof(EntityRollerMKII), sizeof(ObjectRollerMKII), RollerMKII_Update, RollerMKII_LateUpdate,
    ...
    CreateObject(&RotatingSpikes, "RotatingSpikes", sizeof(EntityRotatingSpikes), sizeof(ObjectRotatingSpikes), RotatingSpikes_Update,
    ...
    CreateObject(&RotatingStair, "RotatingStair", sizeof(EntityRotatingStair), sizeof(ObjectRotatingStair), RotatingStair_Update,
    ...
    CreateObject(&RPlaneShifter, "RPlaneShifter", sizeof(EntityRPlaneShifter), sizeof(ObjectRPlaneShifter), RPlaneShifter_Update,
    ...
    CreateObject(&RTeleporter, "RTeleporter", sizeof(EntityRTeleporter), sizeof(ObjectRTeleporter), RTeleporter_Update, RTeleporter_LateUpdate,
    ...
    CreateObject(&RubyPortal, "RubyPortal", sizeof(EntityRubyPortal), sizeof(ObjectRubyPortal), RubyPortal_Update, RubyPortal_LateUpdate,
    ...
    CreateObject(&SaveGame, "SaveGame", sizeof(EntitySaveGame), sizeof(ObjectSaveGame), SaveGame_Update, SaveGame_LateUpdate, SaveGame_StaticUpdate,
                 SaveGame_Draw, SaveGame_Create, SaveGame_StageLoad, SaveGame_EditorDraw, SaveGame_EditorLoad, SaveGame_Serialize);
    CreateObject(&Scarab, "Scarab", sizeof(EntityScarab), sizeof(ObjectScarab), Scarab_Update, Scarab_LateUpdate, Scarab_StaticUpdate, Scarab_Draw,
                 Scarab_Create, Scarab_StageLoad, Scarab_EditorDraw, Scarab_EditorLoad, Scarab_Serialize);
    CreateObject(&SchrodingersCapsule, "SchrodingersCapsule", sizeof(EntitySchrodingersCapsule), sizeof(ObjectSchrodingersCapsule),
    ...
    CreateObject(&ScoreBonus, "ScoreBonus", sizeof(EntityScoreBonus), sizeof(ObjectScoreBonus), ScoreBonus_Update, ScoreBonus_LateUpdate,
    ...
    CreateObject(&ScrewMobile, "ScrewMobile", sizeof(EntityScrewMobile), sizeof(ObjectScrewMobile), ScrewMobile_Update, ScrewMobile_LateUpdate,
    ...
    CreateObject(&SDashWheel, "SDashWheel", sizeof(EntitySDashWheel), sizeof(ObjectSDashWheel), SDashWheel_Update, SDashWheel_LateUpdate,
    ...
    CreateObject(&SeeSaw, "SeeSaw", sizeof(EntitySeeSaw), sizeof(ObjectSeeSaw), SeeSaw_Update, SeeSaw_LateUpdate, SeeSaw_StaticUpdate, SeeSaw_Draw,
                 SeeSaw_Create, SeeSaw_StageLoad, SeeSaw_EditorDraw, SeeSaw_EditorLoad, SeeSaw_Serialize);
    CreateObject(&SeltzerBottle, "SeltzerBottle", sizeof(EntitySeltzerBottle), sizeof(ObjectSeltzerBottle), SeltzerBottle_Update,
    ...
    CreateObject(&SeltzerWater, "SeltzerWater", sizeof(EntitySeltzerWater), sizeof(ObjectSeltzerWater), SeltzerWater_Update, SeltzerWater_LateUpdate,
    ...
    CreateObject(&SentryBug, "SentryBug", sizeof(EntitySentryBug), sizeof(ObjectSentryBug), SentryBug_Update, SentryBug_LateUpdate,
                 SentryBug_StaticUpdate, SentryBug_Draw, SentryBug_Create, SentryBug_StageLoad, SentryBug_EditorDraw, SentryBug_EditorLoad,
                 SentryBug_Serialize);
    CreateObject(&Shield, "Shield", sizeof(EntityShield), sizeof(ObjectShield), Shield_Update, Shield_LateUpdate, Shield_StaticUpdate, Shield_Draw,
                 Shield_Create, Shield_StageLoad, Shield_EditorDraw, Shield_EditorLoad, Shield_Serialize);
    CreateObject(&Shiversaw, "Shiversaw", sizeof(EntityShiversaw), sizeof(ObjectShiversaw), Shiversaw_Update, Shiversaw_LateUpdate,
                 Shiversaw_StaticUpdate, Shiversaw_Draw, Shiversaw_Create, Shiversaw_StageLoad, Shiversaw_EditorDraw, Shiversaw_EditorLoad,
                 Shiversaw_Serialize);
    CreateObject(&ShopWindow, "ShopWindow", sizeof(EntityShopWindow), sizeof(ObjectShopWindow), ShopWindow_Update, ShopWindow_LateUpdate,
    ...
    CreateObject(&Shuriken, "Shuriken", sizeof(EntityShuriken), sizeof(ObjectShuriken), Shuriken_Update, Shuriken_LateUpdate, Shuriken_StaticUpdate,
                 Shuriken_Draw, Shuriken_Create, Shuriken_StageLoad, Shuriken_EditorDraw, Shuriken_EditorLoad, Shuriken_Serialize);
    CreateObject(&Shutterbug, "Shutterbug", sizeof(EntityShutterbug), sizeof(ObjectShutterbug), Shutterbug_Update, Shutterbug_LateUpdate,
    ...
    CreateObject(&SideBarrel, "SideBarrel", sizeof(EntitySideBarrel), sizeof(ObjectSideBarrel), SideBarrel_Update, SideBarrel_LateUpdate,
    ...
    CreateObject(&SignPost, "SignPost", sizeof(EntitySignPost), sizeof(ObjectSignPost), SignPost_Update, SignPost_LateUpdate, SignPost_StaticUpdate,
                 SignPost_Draw, SignPost_Create, SignPost_StageLoad, SignPost_EditorDraw, SignPost_EditorLoad, SignPost_Serialize);
    CreateObject(&SilverSonic, "SilverSonic", sizeof(EntitySilverSonic), sizeof(ObjectSilverSonic), SilverSonic_Update, SilverSonic_LateUpdate,
    ...
    CreateObject(&SizeLaser, "SizeLaser", sizeof(EntitySizeLaser), sizeof(ObjectSizeLaser), SizeLaser_Update, SizeLaser_LateUpdate,
                 SizeLaser_StaticUpdate, SizeLaser_Draw, SizeLaser_Create, SizeLaser_StageLoad, SizeLaser_EditorDraw, SizeLaser_EditorLoad,
                 SizeLaser_Serialize);
    CreateObject(&SkyTeleporter, "SkyTeleporter", sizeof(EntitySkyTeleporter), sizeof(ObjectSkyTeleporter), SkyTeleporter_Update,
    ...
    CreateObject(&Smog, "Smog", sizeof(EntitySmog), sizeof(ObjectSmog), Smog_Update, Smog_LateUpdate, Smog_StaticUpdate, Smog_Draw, Smog_Create,
                 Smog_StageLoad, Smog_EditorDraw, Smog_EditorLoad, Smog_Serialize);
    CreateObject(&Snowflakes, "Snowflakes", sizeof(EntitySnowflakes), sizeof(ObjectSnowflakes), Snowflakes_Update, Snowflakes_LateUpdate,
    ...
    CreateObject(&Sol, "Sol", sizeof(EntitySol), sizeof(ObjectSol), Sol_Update, Sol_LateUpdate, Sol_StaticUpdate, Sol_Draw, Sol_Create, Sol_StageLoad,
                 Sol_EditorDraw, Sol_EditorLoad, Sol_Serialize);
    CreateObject(&Soundboard, "Soundboard", sizeof(EntitySoundboard), sizeof(ObjectSoundboard), Soundboard_Update, Soundboard_LateUpdate,
    ...
    CreateObject(&SP500, "SP500", sizeof(EntitySP500), sizeof(ObjectSP500), SP500_Update, SP500_LateUpdate, SP500_StaticUpdate, SP500_Draw,
                 SP500_Create, SP500_StageLoad, SP500_EditorDraw, SP500_EditorLoad, SP500_Serialize);
    CreateObject(&SP500MkII, "SP500MkII", sizeof(EntitySP500MkII), sizeof(ObjectSP500MkII), SP500MkII_Update, SP500MkII_LateUpdate,
                 SP500MkII_StaticUpdate, SP500MkII_Draw, SP500MkII_Create, SP500MkII_StageLoad, SP500MkII_EditorDraw, SP500MkII_EditorLoad,
                 SP500MkII_Serialize);
    CreateObject(&SparkRail, "SparkRail", sizeof(EntitySparkRail), sizeof(ObjectSparkRail), SparkRail_Update, SparkRail_LateUpdate,
                 SparkRail_StaticUpdate, SparkRail_Draw, SparkRail_Create, SparkRail_StageLoad, SparkRail_EditorDraw, SparkRail_EditorLoad,
                 SparkRail_Serialize);
    CreateObject(&Spear, "Spear", sizeof(EntitySpear), sizeof(ObjectSpear), Spear_Update, Spear_LateUpdate, Spear_StaticUpdate, Spear_Draw,
                 Spear_Create, Spear_StageLoad, Spear_EditorDraw, Spear_EditorLoad, Spear_Serialize);
    CreateObject(&SpecialClear, "SpecialClear", sizeof(EntitySpecialClear), sizeof(ObjectSpecialClear), SpecialClear_Update, SpecialClear_LateUpdate,
    ...
    CreateObject(&SpecialRing, "SpecialRing", sizeof(EntitySpecialRing), sizeof(ObjectSpecialRing), SpecialRing_Update, SpecialRing_LateUpdate,
    ...
    CreateObject(&SpeedBooster, "SpeedBooster", sizeof(EntitySpeedBooster), sizeof(ObjectSpeedBooster), SpeedBooster_Update, SpeedBooster_LateUpdate,
    ...
    CreateObject(&SpeedGate, "SpeedGate", sizeof(EntitySpeedGate), sizeof(ObjectSpeedGate), SpeedGate_Update, SpeedGate_LateUpdate,
                 SpeedGate_StaticUpdate, SpeedGate_Draw, SpeedGate_Create, SpeedGate_StageLoad, SpeedGate_EditorDraw, SpeedGate_EditorLoad,
                 SpeedGate_Serialize);
    CreateObject(&SpiderMobile, "SpiderMobile", sizeof(EntitySpiderMobile), sizeof(ObjectSpiderMobile), SpiderMobile_Update, SpiderMobile_LateUpdate,
    ...
    CreateObject(&SpikeCorridor, "SpikeCorridor", sizeof(EntitySpikeCorridor), sizeof(ObjectSpikeCorridor), SpikeCorridor_Update,
    ...
    CreateObject(&SpikeCrusher, "SpikeCrusher", sizeof(EntitySpikeCrusher), sizeof(ObjectSpikeCrusher), SpikeCrusher_Update, SpikeCrusher_LateUpdate,
    ...
    CreateObject(&SpikeFlail, "SpikeFlail", sizeof(EntitySpikeFlail), sizeof(ObjectSpikeFlail), SpikeFlail_Update, SpikeFlail_LateUpdate,
    ...
    CreateObject(&SpikeLog, "SpikeLog", sizeof(EntitySpikeLog), sizeof(ObjectSpikeLog), SpikeLog_Update, SpikeLog_LateUpdate, SpikeLog_StaticUpdate,
                 SpikeLog_Draw, SpikeLog_Create, SpikeLog_StageLoad, SpikeLog_EditorDraw, SpikeLog_EditorLoad, SpikeLog_Serialize);
    CreateObject(&Spikes, "Spikes", sizeof(EntitySpikes), sizeof(ObjectSpikes), Spikes_Update, Spikes_LateUpdate, Spikes_StaticUpdate, Spikes_Draw,
                 Spikes_Create, Spikes_StageLoad, Spikes_EditorDraw, Spikes_EditorLoad, Spikes_Serialize);
    CreateObject(&SpinBooster, "SpinBooster", sizeof(EntitySpinBooster), sizeof(ObjectSpinBooster), SpinBooster_Update, SpinBooster_LateUpdate,
    ...
    CreateObject(&SpinSign, "SpinSign", sizeof(EntitySpinSign), sizeof(ObjectSpinSign), SpinSign_Update, SpinSign_LateUpdate, SpinSign_StaticUpdate,
                 SpinSign_Draw, SpinSign_Create, SpinSign_StageLoad, SpinSign_EditorDraw, SpinSign_EditorLoad, SpinSign_Serialize);
    CreateObject(&Spiny, "Spiny", sizeof(EntitySpiny), sizeof(ObjectSpiny), Spiny_Update, Spiny_LateUpdate, Spiny_StaticUpdate, Spiny_Draw,
                 Spiny_Create, Spiny_StageLoad, Spiny_EditorDraw, Spiny_EditorLoad, Spiny_Serialize);
    CreateObject(&SpiralPlatform, "SpiralPlatform", sizeof(EntitySpiralPlatform), sizeof(ObjectSpiralPlatform), SpiralPlatform_Update,
    ...
    CreateObject(&Splats, "Splats", sizeof(EntitySplats), sizeof(ObjectSplats), Splats_Update, Splats_LateUpdate, Splats_StaticUpdate, Splats_Draw,
                 Splats_Create, Splats_StageLoad, Splats_EditorDraw, Splats_EditorLoad, Splats_Serialize);
    CreateObject(&Spring, "Spring", sizeof(EntitySpring), sizeof(ObjectSpring), Spring_Update, Spring_LateUpdate, Spring_StaticUpdate, Spring_Draw,
                 Spring_Create, Spring_StageLoad, Spring_EditorDraw, Spring_EditorLoad, Spring_Serialize);
    CreateObject(&Springboard, "Springboard", sizeof(EntitySpringboard), sizeof(ObjectSpringboard), Springboard_Update, Springboard_LateUpdate,
    ...
    CreateObject(&SPZ1Intro, "SPZ1Intro", sizeof(EntitySPZ1Intro), sizeof(ObjectSPZ1Intro), SPZ1Intro_Update, SPZ1Intro_LateUpdate,
                 SPZ1Intro_StaticUpdate, SPZ1Intro_Draw, SPZ1Intro_Create, SPZ1Intro_StageLoad, SPZ1Intro_EditorDraw, SPZ1Intro_EditorLoad,
                 SPZ1Intro_Serialize);
    CreateObject(&SPZ1Setup, "SPZ1Setup", sizeof(EntitySPZ1Setup), sizeof(ObjectSPZ1Setup), SPZ1Setup_Update, SPZ1Setup_LateUpdate,
                 SPZ1Setup_StaticUpdate, SPZ1Setup_Draw, SPZ1Setup_Create, SPZ1Setup_StageLoad, SPZ1Setup_EditorDraw, SPZ1Setup_EditorLoad,
                 SPZ1Setup_Serialize);
    CreateObject(&SPZ2Outro, "SPZ2Outro", sizeof(EntitySPZ2Outro), sizeof(ObjectSPZ2Outro), SPZ2Outro_Update, SPZ2Outro_LateUpdate,
                 SPZ2Outro_StaticUpdate, SPZ2Outro_Draw, SPZ2Outro_Create, SPZ2Outro_StageLoad, SPZ2Outro_EditorDraw, SPZ2Outro_EditorLoad,
                 SPZ2Outro_Serialize);
    CreateObject(&SPZ2Setup, "SPZ2Setup", sizeof(EntitySPZ2Setup), sizeof(ObjectSPZ2Setup), SPZ2Setup_Update, SPZ2Setup_LateUpdate,
                 SPZ2Setup_StaticUpdate, SPZ2Setup_Draw, SPZ2Setup_Create, SPZ2Setup_StageLoad, SPZ2Setup_EditorDraw, SPZ2Setup_EditorLoad,
                 SPZ2Setup_Serialize);
    CreateObject(&SSZ1Intro, "SSZ1Intro", sizeof(EntitySSZ1Intro), sizeof(ObjectSSZ1Intro), SSZ1Intro_Update, SSZ1Intro_LateUpdate,
                 SSZ1Intro_StaticUpdate, SSZ1Intro_Draw, SSZ1Intro_Create, SSZ1Intro_StageLoad, SSZ1Intro_EditorDraw, SSZ1Intro_EditorLoad,
                 SSZ1Intro_Serialize);
    CreateObject(&SSZ1Outro, "SSZ1Outro", sizeof(EntitySSZ1Outro), sizeof(ObjectSSZ1Outro), SSZ1Outro_Update, SSZ1Outro_LateUpdate,
                 SSZ1Outro_StaticUpdate, SSZ1Outro_Draw, SSZ1Outro_Create, SSZ1Outro_StageLoad, SSZ1Outro_EditorDraw, SSZ1Outro_EditorLoad,
                 SSZ1Outro_Serialize);
    CreateObject(&SSZ1Setup, "SSZ1Setup", sizeof(EntitySSZ1Setup), sizeof(ObjectSSZ1Setup), SSZ1Setup_Update, SSZ1Setup_LateUpdate,
                 SSZ1Setup_StaticUpdate, SSZ1Setup_Draw, SSZ1Setup_Create, SSZ1Setup_StageLoad, SSZ1Setup_EditorDraw, SSZ1Setup_EditorLoad,
                 SSZ1Setup_Serialize);
    CreateObject(&SSZ2Setup, "SSZ2Setup", sizeof(EntitySSZ2Setup), sizeof(ObjectSSZ2Setup), SSZ2Setup_Update, SSZ2Setup_LateUpdate,
                 SSZ2Setup_StaticUpdate, SSZ2Setup_Draw, SSZ2Setup_Create, SSZ2Setup_StageLoad, SSZ2Setup_EditorDraw, SSZ2Setup_EditorLoad,
                 SSZ2Setup_Serialize);
    CreateObject(&SSZ3Cutscene, "SSZ3Cutscene", sizeof(EntitySSZ3Cutscene), sizeof(ObjectSSZ3Cutscene), SSZ3Cutscene_Update, SSZ3Cutscene_LateUpdate,
    ...
    CreateObject(&SSZEggman, "SSZEggman", sizeof(EntitySSZEggman), sizeof(ObjectSSZEggman), SSZEggman_Update, SSZEggman_LateUpdate,
                 SSZEggman_StaticUpdate, SSZEggman_Draw, SSZEggman_Create, SSZEggman_StageLoad, SSZEggman_EditorDraw, SSZEggman_EditorLoad,
                 SSZEggman_Serialize);
    CreateObject(&SSZSpikeBall, "SSZSpikeBall", sizeof(EntitySSZSpikeBall), sizeof(ObjectSSZSpikeBall), SSZSpikeBall_Update, SSZSpikeBall_LateUpdate,
    ...
    CreateObject(&SSZSpotlight, "SSZSpotlight", sizeof(EntitySSZSpotlight), sizeof(ObjectSSZSpotlight), SSZSpotlight_Update, SSZSpotlight_LateUpdate,
    ...
    CreateObject(&Staircase, "Staircase", sizeof(EntityStaircase), sizeof(ObjectStaircase), Staircase_Update, Staircase_LateUpdate,
                 Staircase_StaticUpdate, Staircase_Draw, Staircase_Create, Staircase_StageLoad, Staircase_EditorDraw, Staircase_EditorLoad,
                 Staircase_Serialize);
    CreateObject(&Stalactite, "Stalactite", sizeof(EntityStalactite), sizeof(ObjectStalactite), Stalactite_Update, Stalactite_LateUpdate,
    ...
    CreateObject(&StarPost, "StarPost", sizeof(EntityStarPost), sizeof(ObjectStarPost), StarPost_Update, StarPost_LateUpdate, StarPost_StaticUpdate,
                 StarPost_Draw, StarPost_Create, StarPost_StageLoad, StarPost_EditorDraw, StarPost_EditorLoad, StarPost_Serialize);
    CreateObject(&StickyPlatform, "StickyPlatform", sizeof(EntityStickyPlatform), sizeof(ObjectStickyPlatform), StickyPlatform_Update,
    ...
    CreateObject(&Summary, "Summary", sizeof(EntitySummary), sizeof(ObjectSummary), Summary_Update, Summary_LateUpdate, Summary_StaticUpdate,
                 Summary_Draw, Summary_Create, Summary_StageLoad, Summary_EditorDraw, Summary_EditorLoad, Summary_Serialize);
    CreateObject(&SummaryEmerald, "SummaryEmerald", sizeof(EntitySummaryEmerald), sizeof(ObjectSummaryEmerald), SummaryEmerald_Update,
    ...
    CreateObject(&SuperSparkle, "SuperSparkle", sizeof(EntitySuperSparkle), sizeof(ObjectSuperSparkle), SuperSparkle_Update, SuperSparkle_LateUpdate,
    ...
    CreateObject(&Sweep, "Sweep", sizeof(EntitySweep), sizeof(ObjectSweep), Sweep_Update, Sweep_LateUpdate, Sweep_StaticUpdate, Sweep_Draw,
                 Sweep_Create, Sweep_StageLoad, Sweep_EditorDraw, Sweep_EditorLoad, Sweep_Serialize);
    CreateObject(&SwingRope, "SwingRope", sizeof(EntitySwingRope), sizeof(ObjectSwingRope), SwingRope_Update, SwingRope_LateUpdate,
                 SwingRope_StaticUpdate, SwingRope_Draw, SwingRope_Create, SwingRope_StageLoad, SwingRope_EditorDraw, SwingRope_EditorLoad,
                 SwingRope_Serialize);
    CreateObject(&SwitchDoor, "SwitchDoor", sizeof(EntitySwitchDoor), sizeof(ObjectSwitchDoor), SwitchDoor_Update, SwitchDoor_LateUpdate,
    ...
    CreateObject(&Syringe, "Syringe", sizeof(EntitySyringe), sizeof(ObjectSyringe), Syringe_Update, Syringe_LateUpdate, Syringe_StaticUpdate,
                 Syringe_Draw, Syringe_Create, Syringe_StageLoad, Syringe_EditorDraw, Syringe_EditorLoad, Syringe_Serialize);
    CreateObject(&TAEmerald, "TAEmerald", sizeof(EntityTAEmerald), sizeof(ObjectTAEmerald), TAEmerald_Update, TAEmerald_LateUpdate,
                 TAEmerald_StaticUpdate, TAEmerald_Draw, TAEmerald_Create, TAEmerald_StageLoad, TAEmerald_EditorDraw, TAEmerald_EditorLoad,
                 TAEmerald_Serialize);
    CreateObject(&Technosqueek, "Technosqueek", sizeof(EntityTechnosqueek), sizeof(ObjectTechnosqueek), Technosqueek_Update, Technosqueek_LateUpdate,
    ...
    CreateObject(&TeeterTotter, "TeeterTotter", sizeof(EntityTeeterTotter), sizeof(ObjectTeeterTotter), TeeterTotter_Update, TeeterTotter_LateUpdate,
    ...
    CreateObject(&TetherBall, "TetherBall", sizeof(EntityTetherBall), sizeof(ObjectTetherBall), TetherBall_Update, TetherBall_LateUpdate,
    ...
    CreateObject(&ThanksSetup, "ThanksSetup", sizeof(EntityThanksSetup), sizeof(ObjectThanksSetup), ThanksSetup_Update, ThanksSetup_LateUpdate,
    ...
    CreateObject(&ThoughtBubble, "ThoughtBubble", sizeof(EntityThoughtBubble), sizeof(ObjectThoughtBubble), ThoughtBubble_Update,
    ...
    CreateObject(&TilePlatform, "TilePlatform", sizeof(EntityTilePlatform), sizeof(ObjectTilePlatform), TilePlatform_Update, TilePlatform_LateUpdate,
    ...
    CreateObject(&TimeAttackGate, "TimeAttackGate", sizeof(EntityTimeAttackGate), sizeof(ObjectTimeAttackGate), TimeAttackGate_Update,
    ...
    CreateObject(&TimeAttackMenu, "TimeAttackMenu", sizeof(EntityTimeAttackMenu), sizeof(ObjectTimeAttackMenu), TimeAttackMenu_Update,
    ...
    CreateObject(&TimePost, "TimePost", sizeof(EntityTimePost), sizeof(ObjectTimePost), TimePost_Update, TimePost_LateUpdate, TimePost_StaticUpdate,
                 TimePost_Draw, TimePost_Create, TimePost_StageLoad, TimePost_EditorDraw, TimePost_EditorLoad, TimePost_Serialize);
    CreateObject(&TimeTravelSetup, "TimeTravelSetup", sizeof(EntityTimeTravelSetup), sizeof(ObjectTimeTravelSetup), TimeTravelSetup_Update,
    ...
    CreateObject(&TippingPlatform, "TippingPlatform", sizeof(EntityTippingPlatform), sizeof(ObjectTippingPlatform), TippingPlatform_Update,
    ...
    CreateObject(&Title3DSprite, "Title3DSprite", sizeof(EntityTitle3DSprite), sizeof(ObjectTitle3DSprite), Title3DSprite_Update,
    ...
    CreateObject(&TitleBG, "TitleBG", sizeof(EntityTitleBG), sizeof(ObjectTitleBG), TitleBG_Update, TitleBG_LateUpdate, TitleBG_StaticUpdate,
                 TitleBG_Draw, TitleBG_Create, TitleBG_StageLoad, TitleBG_EditorDraw, TitleBG_EditorLoad, TitleBG_Serialize);
    CreateObject(&TitleCard, "TitleCard", sizeof(EntityTitleCard), sizeof(ObjectTitleCard), TitleCard_Update, TitleCard_LateUpdate,
                 TitleCard_StaticUpdate, TitleCard_Draw, TitleCard_Create, TitleCard_StageLoad, TitleCard_EditorDraw, TitleCard_EditorLoad,
                 TitleCard_Serialize);
    CreateObject(&TitleEggman, "TitleEggman", sizeof(EntityTitleEggman), sizeof(ObjectTitleEggman), TitleEggman_Update, TitleEggman_LateUpdate,
    ...
    CreateObject(&TitleLogo, "TitleLogo", sizeof(EntityTitleLogo), sizeof(ObjectTitleLogo), TitleLogo_Update, TitleLogo_LateUpdate,
                 TitleLogo_StaticUpdate, TitleLogo_Draw, TitleLogo_Create, TitleLogo_StageLoad, TitleLogo_EditorDraw, TitleLogo_EditorLoad,
                 TitleLogo_Serialize);
    CreateObject(&TitleSetup, "TitleSetup", sizeof(EntityTitleSetup), sizeof(ObjectTitleSetup), TitleSetup_Update, TitleSetup_LateUpdate,
    ...
    CreateObject(&TitleSonic, "TitleSonic", sizeof(EntityTitleSonic), sizeof(ObjectTitleSonic), TitleSonic_Update, TitleSonic_LateUpdate,
    ...
    CreateObject(&TMZ1Outro, "TMZ1Outro", sizeof(EntityTMZ1Outro), sizeof(ObjectTMZ1Outro), TMZ1Outro_Update, TMZ1Outro_LateUpdate,
                 TMZ1Outro_StaticUpdate, TMZ1Outro_Draw, TMZ1Outro_Create, TMZ1Outro_StageLoad, TMZ1Outro_EditorDraw, TMZ1Outro_EditorLoad,
                 TMZ1Outro_Serialize);
    CreateObject(&TMZ1Setup, "TMZ1Setup", sizeof(EntityTMZ1Setup), sizeof(ObjectTMZ1Setup), TMZ1Setup_Update, TMZ1Setup_LateUpdate,
                 TMZ1Setup_StaticUpdate, TMZ1Setup_Draw, TMZ1Setup_Create, TMZ1Setup_StageLoad, TMZ1Setup_EditorDraw, TMZ1Setup_EditorLoad,
                 TMZ1Setup_Serialize);
    CreateObject(&TMZ2Outro, "TMZ2Outro", sizeof(EntityTMZ2Outro), sizeof(ObjectTMZ2Outro), TMZ2Outro_Update, TMZ2Outro_LateUpdate,
                 TMZ2Outro_StaticUpdate, TMZ2Outro_Draw, TMZ2Outro_Create, TMZ2Outro_StageLoad, TMZ2Outro_EditorDraw, TMZ2Outro_EditorLoad,
                 TMZ2Outro_Serialize);
    CreateObject(&TMZ2Setup, "TMZ2Setup", sizeof(EntityTMZ2Setup), sizeof(ObjectTMZ2Setup), TMZ2Setup_Update, TMZ2Setup_LateUpdate,
                 TMZ2Setup_StaticUpdate, TMZ2Setup_Draw, TMZ2Setup_Create, TMZ2Setup_StageLoad, TMZ2Setup_EditorDraw, TMZ2Setup_EditorLoad,
                 TMZ2Setup_Serialize);
    CreateObject(&TMZ3Setup, "TMZ3Setup", sizeof(EntityTMZ3Setup), sizeof(ObjectTMZ3Setup), TMZ3Setup_Update, TMZ3Setup_LateUpdate,
                 TMZ3Setup_StaticUpdate, TMZ3Setup_Draw, TMZ3Setup_Create, TMZ3Setup_StageLoad, TMZ3Setup_EditorDraw, TMZ3Setup_EditorLoad,
                 TMZ3Setup_Serialize);
    CreateObject(&TMZAlert, "TMZAlert", sizeof(EntityTMZAlert), sizeof(ObjectTMZAlert), TMZAlert_Update, TMZAlert_LateUpdate, TMZAlert_StaticUpdate,
                 TMZAlert_Draw, TMZAlert_Create, TMZAlert_StageLoad, TMZAlert_EditorDraw, TMZAlert_EditorLoad, TMZAlert_Serialize);
    CreateObject(&TMZBarrier, "TMZBarrier", sizeof(EntityTMZBarrier), sizeof(ObjectTMZBarrier), TMZBarrier_Update, TMZBarrier_LateUpdate,
    ...
    CreateObject(&TMZCable, "TMZCable", sizeof(EntityTMZCable), sizeof(ObjectTMZCable), TMZCable_Update, TMZCable_LateUpdate, TMZCable_StaticUpdate,
                 TMZCable_Draw, TMZCable_Create, TMZCable_StageLoad, TMZCable_EditorDraw, TMZCable_EditorLoad, TMZCable_Serialize);
    CreateObject(&TMZFlames, "TMZFlames", sizeof(EntityTMZFlames), sizeof(ObjectTMZFlames), TMZFlames_Update, TMZFlames_LateUpdate,
                 TMZFlames_StaticUpdate, TMZFlames_Draw, TMZFlames_Create, TMZFlames_StageLoad, TMZFlames_EditorDraw, TMZFlames_EditorLoad,
                 TMZFlames_Serialize);
    CreateObject(&Tornado, "Tornado", sizeof(EntityTornado), sizeof(ObjectTornado), Tornado_Update, Tornado_LateUpdate, Tornado_StaticUpdate,
                 Tornado_Draw, Tornado_Create, Tornado_StageLoad, Tornado_EditorDraw, Tornado_EditorLoad, Tornado_Serialize);
    CreateObject(&TornadoPath, "TornadoPath", sizeof(EntityTornadoPath), sizeof(ObjectTornadoPath), TornadoPath_Update, TornadoPath_LateUpdate,
    ...
    CreateObject(&Toxomister, "Toxomister", sizeof(EntityToxomister), sizeof(ObjectToxomister), Toxomister_Update, Toxomister_LateUpdate,
    ...
    CreateObject(&TransportTube, "TransportTube", sizeof(EntityTransportTube), sizeof(ObjectTransportTube), TransportTube_Update,
    ...
    CreateObject(&TryAgain, "TryAgain", sizeof(EntityTryAgain), sizeof(ObjectTryAgain), TryAgain_Update, TryAgain_LateUpdate, TryAgain_StaticUpdate,
                 TryAgain_Draw, TryAgain_Create, TryAgain_StageLoad, TryAgain_EditorDraw, TryAgain_EditorLoad, TryAgain_Serialize);
    CreateObject(&TryAgainE, "TryAgainE", sizeof(EntityTryAgainE), sizeof(ObjectTryAgainE), TryAgainE_Update, TryAgainE_LateUpdate,
                 TryAgainE_StaticUpdate, TryAgainE_Draw, TryAgainE_Create, TryAgainE_StageLoad, TryAgainE_EditorDraw, TryAgainE_EditorLoad,
                 TryAgainE_Serialize);
    CreateObject(&TTCutscene, "TTCutscene", sizeof(EntityTTCutscene), sizeof(ObjectTTCutscene), TTCutscene_Update, TTCutscene_LateUpdate,
    ...
    CreateObject(&TubeSpring, "TubeSpring", sizeof(EntityTubeSpring), sizeof(ObjectTubeSpring), TubeSpring_Update, TubeSpring_LateUpdate,
    ...
    CreateObject(&Tubinaut, "Tubinaut", sizeof(EntityTubinaut), sizeof(ObjectTubinaut), Tubinaut_Update, Tubinaut_LateUpdate, Tubinaut_StaticUpdate,
                 Tubinaut_Draw, Tubinaut_Create, Tubinaut_StageLoad, Tubinaut_EditorDraw, Tubinaut_EditorLoad, Tubinaut_Serialize);
    CreateObject(&Tuesday, "Tuesday", sizeof(EntityTuesday), sizeof(ObjectTuesday), Tuesday_Update, Tuesday_LateUpdate, Tuesday_StaticUpdate,
                 Tuesday_Draw, Tuesday_Create, Tuesday_StageLoad, Tuesday_EditorDraw, Tuesday_EditorLoad, Tuesday_Serialize);
    CreateObject(&Turbine, "Turbine", sizeof(EntityTurbine), sizeof(ObjectTurbine), Turbine_Update, Turbine_LateUpdate, Turbine_StaticUpdate,
                 Turbine_Draw, Turbine_Create, Turbine_StageLoad, Turbine_EditorDraw, Turbine_EditorLoad, Turbine_Serialize);
    CreateObject(&TurboSpiker, "TurboSpiker", sizeof(EntityTurboSpiker), sizeof(ObjectTurboSpiker), TurboSpiker_Update, TurboSpiker_LateUpdate,
    ...
    CreateObject(&TurboTurtle, "TurboTurtle", sizeof(EntityTurboTurtle), sizeof(ObjectTurboTurtle), TurboTurtle_Update, TurboTurtle_LateUpdate,
    ...
    CreateObject(&Turntable, "Turntable", sizeof(EntityTurntable), sizeof(ObjectTurntable), Turntable_Update, Turntable_LateUpdate,
                 Turntable_StaticUpdate, Turntable_Draw, Turntable_Create, Turntable_StageLoad, Turntable_EditorDraw, Turntable_EditorLoad,
                 Turntable_Serialize);
    CreateObject(&TurretSwitch, "TurretSwitch", sizeof(EntityTurretSwitch), sizeof(ObjectTurretSwitch), TurretSwitch_Update, TurretSwitch_LateUpdate,
    ...
    CreateObject(&TVFlyingBattery, "TVFlyingBattery", sizeof(EntityTVFlyingBattery), sizeof(ObjectTVFlyingBattery), TVFlyingBattery_Update,
    ...
    CreateObject(&TVPole, "TVPole", sizeof(EntityTVPole), sizeof(ObjectTVPole), TVPole_Update, TVPole_LateUpdate, TVPole_StaticUpdate, TVPole_Draw,
                 TVPole_Create, TVPole_StageLoad, TVPole_EditorDraw, TVPole_EditorLoad, TVPole_Serialize);
    CreateObject(&TVVan, "TVVan", sizeof(EntityTVVan), sizeof(ObjectTVVan), TVVan_Update, TVVan_LateUpdate, TVVan_StaticUpdate, TVVan_Draw,
                 TVVan_Create, TVVan_StageLoad, TVVan_EditorDraw, TVVan_EditorLoad, TVVan_Serialize);
    CreateObject(&TwistedTubes, "TwistedTubes", sizeof(EntityTwistedTubes), sizeof(ObjectTwistedTubes), TwistedTubes_Update, TwistedTubes_LateUpdate,
    ...
    CreateObject(&TwistingDoor, "TwistingDoor", sizeof(EntityTwistingDoor), sizeof(ObjectTwistingDoor), TwistingDoor_Update, TwistingDoor_LateUpdate,
    ...
    CreateObject(&TwistingSlide, "TwistingSlide", sizeof(EntityTwistingSlide), sizeof(ObjectTwistingSlide), TwistingSlide_Update,
    ...
    CreateObject(&UberCaterkiller, "UberCaterkiller", sizeof(EntityUberCaterkiller), sizeof(ObjectUberCaterkiller), UberCaterkiller_Update,
    ...
    CreateObject(&UFO_Camera, "UFO_Camera", sizeof(EntityUFO_Camera), sizeof(ObjectUFO_Camera), UFO_Camera_Update, UFO_Camera_LateUpdate,
    ...
    CreateObject(&UFO_Circuit, "UFO_Circuit", sizeof(EntityUFO_Circuit), sizeof(ObjectUFO_Circuit), UFO_Circuit_Update, UFO_Circuit_LateUpdate,
    ...
    CreateObject(&UFO_Decoration, "UFO_Decoration", sizeof(EntityUFO_Decoration), sizeof(ObjectUFO_Decoration), UFO_Decoration_Update,
    ...
    CreateObject(&UFO_Dust, "UFO_Dust", sizeof(EntityUFO_Dust), sizeof(ObjectUFO_Dust), UFO_Dust_Update, UFO_Dust_LateUpdate, UFO_Dust_StaticUpdate,
                 UFO_Dust_Draw, UFO_Dust_Create, UFO_Dust_StageLoad, UFO_Dust_EditorDraw, UFO_Dust_EditorLoad, UFO_Dust_Serialize);
    CreateObject(&UFO_HUD, "UFO_HUD", sizeof(EntityUFO_HUD), sizeof(ObjectUFO_HUD), UFO_HUD_Update, UFO_HUD_LateUpdate, UFO_HUD_StaticUpdate,
                 UFO_HUD_Draw, UFO_HUD_Create, UFO_HUD_StageLoad, UFO_HUD_EditorDraw, UFO_HUD_EditorLoad, UFO_HUD_Serialize);
    CreateObject(&UFO_ItemBox, "UFO_ItemBox", sizeof(EntityUFO_ItemBox), sizeof(ObjectUFO_ItemBox), UFO_ItemBox_Update, UFO_ItemBox_LateUpdate,
    ...
    CreateObject(&UFO_Message, "UFO_Message", sizeof(EntityUFO_Message), sizeof(ObjectUFO_Message), UFO_Message_Update, UFO_Message_LateUpdate,
    ...
    CreateObject(&UFO_Plasma, "UFO_Plasma", sizeof(EntityUFO_Plasma), sizeof(ObjectUFO_Plasma), UFO_Plasma_Update, UFO_Plasma_LateUpdate,
    ...
    CreateObject(&UFO_Player, "UFO_Player", sizeof(EntityUFO_Player), sizeof(ObjectUFO_Player), UFO_Player_Update, UFO_Player_LateUpdate,
    ...
    CreateObject(&UFO_Ring, "UFO_Ring", sizeof(EntityUFO_Ring), sizeof(ObjectUFO_Ring), UFO_Ring_Update, UFO_Ring_LateUpdate, UFO_Ring_StaticUpdate,
                 UFO_Ring_Draw, UFO_Ring_Create, UFO_Ring_StageLoad, UFO_Ring_EditorDraw, UFO_Ring_EditorLoad, UFO_Ring_Serialize);
    CreateObject(&UFO_Setup, "UFO_Setup", sizeof(EntityUFO_Setup), sizeof(ObjectUFO_Setup), UFO_Setup_Update, UFO_Setup_LateUpdate,
                 UFO_Setup_StaticUpdate, UFO_Setup_Draw, UFO_Setup_Create, UFO_Setup_StageLoad, UFO_Setup_EditorDraw, UFO_Setup_EditorLoad,
                 UFO_Setup_Serialize);
    CreateObject(&UFO_Shadow, "UFO_Shadow", sizeof(EntityUFO_Shadow), sizeof(ObjectUFO_Shadow), UFO_Shadow_Update, UFO_Shadow_LateUpdate,
    ...
    CreateObject(&UFO_SpeedLines, "UFO_SpeedLines", sizeof(EntityUFO_SpeedLines), sizeof(ObjectUFO_SpeedLines), UFO_SpeedLines_Update,
    ...
    CreateObject(&UFO_Sphere, "UFO_Sphere", sizeof(EntityUFO_Sphere), sizeof(ObjectUFO_Sphere), UFO_Sphere_Update, UFO_Sphere_LateUpdate,
    ...
    CreateObject(&UFO_Springboard, "UFO_Springboard", sizeof(EntityUFO_Springboard), sizeof(ObjectUFO_Springboard), UFO_Springboard_Update,
    ...
    CreateObject(&UFO_Water, "UFO_Water", sizeof(EntityUFO_Water), sizeof(ObjectUFO_Water), UFO_Water_Update, UFO_Water_LateUpdate,
                 UFO_Water_StaticUpdate, UFO_Water_Draw, UFO_Water_Create, UFO_Water_StageLoad, UFO_Water_EditorDraw, UFO_Water_EditorLoad,
                 UFO_Water_Serialize);
    CreateObject(&UIBackground, "UIBackground", sizeof(EntityUIBackground), sizeof(ObjectUIBackground), UIBackground_Update, UIBackground_LateUpdate,
    ...
    CreateObject(&UIButton, "UIButton", sizeof(EntityUIButton), sizeof(ObjectUIButton), UIButton_Update, UIButton_LateUpdate, UIButton_StaticUpdate,
                 UIButton_Draw, UIButton_Create, UIButton_StageLoad, UIButton_EditorDraw, UIButton_EditorLoad, UIButton_Serialize);
    CreateObject(&UIButtonLabel, "UIButtonLabel", sizeof(EntityUIButtonLabel), sizeof(ObjectUIButtonLabel), UIButtonLabel_Update,
    ...
    CreateObject(&UIButtonPrompt, "UIButtonPrompt", sizeof(EntityUIButtonPrompt), sizeof(ObjectUIButtonPrompt), UIButtonPrompt_Update,
    ...
    CreateObject(&UICarousel, "UICarousel", sizeof(EntityUICarousel), sizeof(ObjectUICarousel), UICarousel_Update, UICarousel_LateUpdate,
    ...
    CreateObject(&UICharButton, "UICharButton", sizeof(EntityUICharButton), sizeof(ObjectUICharButton), UICharButton_Update, UICharButton_LateUpdate,
    ...
    CreateObject(&UIChoice, "UIChoice", sizeof(EntityUIChoice), sizeof(ObjectUIChoice), UIChoice_Update, UIChoice_LateUpdate, UIChoice_StaticUpdate,
                 UIChoice_Draw, UIChoice_Create, UIChoice_StageLoad, UIChoice_EditorDraw, UIChoice_EditorLoad, UIChoice_Serialize);
    CreateObject(&UIControl, "UIControl", sizeof(EntityUIControl), sizeof(ObjectUIControl), UIControl_Update, UIControl_LateUpdate,
                 UIControl_StaticUpdate, UIControl_Draw, UIControl_Create, UIControl_StageLoad, UIControl_EditorDraw, UIControl_EditorLoad,
                 UIControl_Serialize);
    CreateObject(&UICreditsText, "UICreditsText", sizeof(EntityUICreditsText), sizeof(ObjectUICreditsText), UICreditsText_Update,
    ...
    CreateObject(&UIDialog, "UIDialog", sizeof(EntityUIDialog), sizeof(ObjectUIDialog), UIDialog_Update, UIDialog_LateUpdate, UIDialog_StaticUpdate,
                 UIDialog_Draw, UIDialog_Create, UIDialog_StageLoad, UIDialog_EditorDraw, UIDialog_EditorLoad, UIDialog_Serialize);
    CreateObject(&UIDiorama, "UIDiorama", sizeof(EntityUIDiorama), sizeof(ObjectUIDiorama), UIDiorama_Update, UIDiorama_LateUpdate,
                 UIDiorama_StaticUpdate, UIDiorama_Draw, UIDiorama_Create, UIDiorama_StageLoad, UIDiorama_EditorDraw, UIDiorama_EditorLoad,
                 UIDiorama_Serialize);
    CreateObject(&UIHeading, "UIHeading", sizeof(EntityUIHeading), sizeof(ObjectUIHeading), UIHeading_Update, UIHeading_LateUpdate,
                 UIHeading_StaticUpdate, UIHeading_Draw, UIHeading_Create, UIHeading_StageLoad, UIHeading_EditorDraw, UIHeading_EditorLoad,
                 UIHeading_Serialize);
    CreateObject(&UIInfoLabel, "UIInfoLabel", sizeof(EntityUIInfoLabel), sizeof(ObjectUIInfoLabel), UIInfoLabel_Update, UIInfoLabel_LateUpdate,
    ...
    CreateObject(&UIKeyBinder, "UIKeyBinder", sizeof(EntityUIKeyBinder), sizeof(ObjectUIKeyBinder), UIKeyBinder_Update, UIKeyBinder_LateUpdate,
    ...
    CreateObject(&UILeaderboard, "UILeaderboard", sizeof(EntityUILeaderboard), sizeof(ObjectUILeaderboard), UILeaderboard_Update,
    ...
    CreateObject(&UIMedallionPanel, "UIMedallionPanel", sizeof(EntityUIMedallionPanel), sizeof(ObjectUIMedallionPanel), UIMedallionPanel_Update,
    ...
    CreateObject(&UIModeButton, "UIModeButton", sizeof(EntityUIModeButton), sizeof(ObjectUIModeButton), UIModeButton_Update, UIModeButton_LateUpdate,
    ...
    CreateObject(&UIOptionPanel, "UIOptionPanel", sizeof(EntityUIOptionPanel), sizeof(ObjectUIOptionPanel), UIOptionPanel_Update,
    ...
    CreateObject(&UIPicture, "UIPicture", sizeof(EntityUIPicture), sizeof(ObjectUIPicture), UIPicture_Update, UIPicture_LateUpdate,
                 UIPicture_StaticUpdate, UIPicture_Draw, UIPicture_Create, UIPicture_StageLoad, UIPicture_EditorDraw, UIPicture_EditorLoad,
                 UIPicture_Serialize);
    CreateObject(&UIPopover, "UIPopover", sizeof(EntityUIPopover), sizeof(ObjectUIPopover), UIPopover_Update, UIPopover_LateUpdate,
                 UIPopover_StaticUpdate, UIPopover_Draw, UIPopover_Create, UIPopover_StageLoad, UIPopover_EditorDraw, UIPopover_EditorLoad,
                 UIPopover_Serialize);
    CreateObject(&UIRankButton, "UIRankButton", sizeof(EntityUIRankButton), sizeof(ObjectUIRankButton), UIRankButton_Update, UIRankButton_LateUpdate,
    ...
    CreateObject(&UIReplayCarousel, "UIReplayCarousel", sizeof(EntityUIReplayCarousel), sizeof(ObjectUIReplayCarousel), UIReplayCarousel_Update,
    ...
    CreateObject(&UIResPicker, "UIResPicker", sizeof(EntityUIResPicker), sizeof(ObjectUIResPicker), UIResPicker_Update, UIResPicker_LateUpdate,
    ...
    CreateObject(&UISaveSlot, "UISaveSlot", sizeof(EntityUISaveSlot), sizeof(ObjectUISaveSlot), UISaveSlot_Update, UISaveSlot_LateUpdate,
    ...
    CreateObject(&UIShifter, "UIShifter", sizeof(EntityUIShifter), sizeof(ObjectUIShifter), UIShifter_Update, UIShifter_LateUpdate,
                 UIShifter_StaticUpdate, UIShifter_Draw, UIShifter_Create, UIShifter_StageLoad, UIShifter_EditorDraw, UIShifter_EditorLoad,
                 UIShifter_Serialize);
    CreateObject(&UISlider, "UISlider", sizeof(EntityUISlider), sizeof(ObjectUISlider), UISlider_Update, UISlider_LateUpdate, UISlider_StaticUpdate,
                 UISlider_Draw, UISlider_Create, UISlider_StageLoad, UISlider_EditorDraw, UISlider_EditorLoad, UISlider_Serialize);
    CreateObject(&UISubHeading, "UISubHeading", sizeof(EntityUISubHeading), sizeof(ObjectUISubHeading), UISubHeading_Update, UISubHeading_LateUpdate,
    ...
    CreateObject(&UITABanner, "UITABanner", sizeof(EntityUITABanner), sizeof(ObjectUITABanner), UITABanner_Update, UITABanner_LateUpdate,
    ...
    CreateObject(&UITAZoneModule, "UITAZoneModule", sizeof(EntityUITAZoneModule), sizeof(ObjectUITAZoneModule), UITAZoneModule_Update,
    ...
    CreateObject(&UIText, "UIText", sizeof(EntityUIText), sizeof(ObjectUIText), UIText_Update, UIText_LateUpdate, UIText_StaticUpdate, UIText_Draw,
                 UIText_Create, UIText_StageLoad, UIText_EditorDraw, UIText_EditorLoad, UIText_Serialize);
    CreateObject(&UITransition, "UITransition", sizeof(EntityUITransition), sizeof(ObjectUITransition), UITransition_Update, UITransition_LateUpdate,
    ...
    CreateObject(&UIUsernamePopup, "UIUsernamePopup", sizeof(EntityUIUsernamePopup), sizeof(ObjectUIUsernamePopup), UIUsernamePopup_Update,
    ...
    CreateObject(&UIVideo, "UIVideo", sizeof(EntityUIVideo), sizeof(ObjectUIVideo), UIVideo_Update, UIVideo_LateUpdate, UIVideo_StaticUpdate,
                 UIVideo_Draw, UIVideo_Create, UIVideo_StageLoad, UIVideo_EditorDraw, UIVideo_EditorLoad, UIVideo_Serialize);
    CreateObject(&UIVsCharSelector, "UIVsCharSelector", sizeof(EntityUIVsCharSelector), sizeof(ObjectUIVsCharSelector), UIVsCharSelector_Update,
    ...
    CreateObject(&UIVsResults, "UIVsResults", sizeof(EntityUIVsResults), sizeof(ObjectUIVsResults), UIVsResults_Update, UIVsResults_LateUpdate,
    ...
    CreateObject(&UIVsRoundPicker, "UIVsRoundPicker", sizeof(EntityUIVsRoundPicker), sizeof(ObjectUIVsRoundPicker), UIVsRoundPicker_Update,
    ...
    CreateObject(&UIVsScoreboard, "UIVsScoreboard", sizeof(EntityUIVsScoreboard), sizeof(ObjectUIVsScoreboard), UIVsScoreboard_Update,
    ...
    CreateObject(&UIVsZoneButton, "UIVsZoneButton", sizeof(EntityUIVsZoneButton), sizeof(ObjectUIVsZoneButton), UIVsZoneButton_Update,
    ...
    CreateObject(&UIWaitSpinner, "UIWaitSpinner", sizeof(EntityUIWaitSpinner), sizeof(ObjectUIWaitSpinner), UIWaitSpinner_Update,
    ...
    CreateObject(&UIWidgets, "UIWidgets", sizeof(EntityUIWidgets), sizeof(ObjectUIWidgets), UIWidgets_Update, UIWidgets_LateUpdate,
                 UIWidgets_StaticUpdate, UIWidgets_Draw, UIWidgets_Create, UIWidgets_StageLoad, UIWidgets_EditorDraw, UIWidgets_EditorLoad,
                 UIWidgets_Serialize);
    CreateObject(&UIWinSize, "UIWinSize", sizeof(EntityUIWinSize), sizeof(ObjectUIWinSize), UIWinSize_Update, UIWinSize_LateUpdate,
                 UIWinSize_StaticUpdate, UIWinSize_Draw, UIWinSize_Create, UIWinSize_StageLoad, UIWinSize_EditorDraw, UIWinSize_EditorLoad,
                 UIWinSize_Serialize);
    CreateObject(&UncurlPlant, "UncurlPlant", sizeof(EntityUncurlPlant), sizeof(ObjectUncurlPlant), UncurlPlant_Update, UncurlPlant_LateUpdate,
    ...
    CreateObject(&Valve, "Valve", sizeof(EntityValve), sizeof(ObjectValve), Valve_Update, Valve_LateUpdate, Valve_StaticUpdate, Valve_Draw,
                 Valve_Create, Valve_StageLoad, Valve_EditorDraw, Valve_EditorLoad, Valve_Serialize);
    CreateObject(&VanishPlatform, "VanishPlatform", sizeof(EntityVanishPlatform), sizeof(ObjectVanishPlatform), VanishPlatform_Update,
    ...
    CreateObject(&Vultron, "Vultron", sizeof(EntityVultron), sizeof(ObjectVultron), Vultron_Update, Vultron_LateUpdate, Vultron_StaticUpdate,
                 Vultron_Draw, Vultron_Create, Vultron_StageLoad, Vultron_EditorDraw, Vultron_EditorLoad, Vultron_Serialize);
    CreateObject(&WalkerLegs, "WalkerLegs", sizeof(EntityWalkerLegs), sizeof(ObjectWalkerLegs), WalkerLegs_Update, WalkerLegs_LateUpdate,
    ...
    CreateObject(&WallBumper, "WallBumper", sizeof(EntityWallBumper), sizeof(ObjectWallBumper), WallBumper_Update, WallBumper_LateUpdate,
    ...
    CreateObject(&WarpDoor, "WarpDoor", sizeof(EntityWarpDoor), sizeof(ObjectWarpDoor), WarpDoor_Update, WarpDoor_LateUpdate, WarpDoor_StaticUpdate,
                 WarpDoor_Draw, WarpDoor_Create, WarpDoor_StageLoad, WarpDoor_EditorDraw, WarpDoor_EditorLoad, WarpDoor_Serialize);
    CreateObject(&Water, "Water", sizeof(EntityWater), sizeof(ObjectWater), Water_Update, Water_LateUpdate, Water_StaticUpdate, Water_Draw,
                 Water_Create, Water_StageLoad, Water_EditorDraw, Water_EditorLoad, Water_Serialize);
    CreateObject(&WaterfallSound, "WaterfallSound", sizeof(EntityWaterfallSound), sizeof(ObjectWaterfallSound), WaterfallSound_Update,
    ...
    CreateObject(&WaterGush, "WaterGush", sizeof(EntityWaterGush), sizeof(ObjectWaterGush), WaterGush_Update, WaterGush_LateUpdate,
                 WaterGush_StaticUpdate, WaterGush_Draw, WaterGush_Create, WaterGush_StageLoad, WaterGush_EditorDraw, WaterGush_EditorLoad,
                 WaterGush_Serialize);
    CreateObject(&WeatherMobile, "WeatherMobile", sizeof(EntityWeatherMobile), sizeof(ObjectWeatherMobile), WeatherMobile_Update,
    ...
    CreateObject(&WeatherTV, "WeatherTV", sizeof(EntityWeatherTV), sizeof(ObjectWeatherTV), WeatherTV_Update, WeatherTV_LateUpdate,
                 WeatherTV_StaticUpdate, WeatherTV_Draw, WeatherTV_Create, WeatherTV_StageLoad, WeatherTV_EditorDraw, WeatherTV_EditorLoad,
                 WeatherTV_Serialize);
    CreateObject(&Whirlpool, "Whirlpool", sizeof(EntityWhirlpool), sizeof(ObjectWhirlpool), Whirlpool_Update, Whirlpool_LateUpdate,
                 Whirlpool_StaticUpdate, Whirlpool_Draw, Whirlpool_Create, Whirlpool_StageLoad, Whirlpool_EditorDraw, Whirlpool_EditorLoad,
                 Whirlpool_Serialize);
    CreateObject(&WoodChipper, "WoodChipper", sizeof(EntityWoodChipper), sizeof(ObjectWoodChipper), WoodChipper_Update, WoodChipper_LateUpdate,
    ...
    CreateObject(&Woodrow, "Woodrow", sizeof(EntityWoodrow), sizeof(ObjectWoodrow), Woodrow_Update, Woodrow_LateUpdate, Woodrow_StaticUpdate,
                 Woodrow_Draw, Woodrow_Create, Woodrow_StageLoad, Woodrow_EditorDraw, Woodrow_EditorLoad, Woodrow_Serialize);
    CreateObject(&YoyoPulley, "YoyoPulley", sizeof(EntityYoyoPulley), sizeof(ObjectYoyoPulley), YoyoPulley_Update, YoyoPulley_LateUpdate,
    ...
    CreateObject(&ZipLine, "ZipLine", sizeof(EntityZipLine), sizeof(ObjectZipLine), ZipLine_Update, ZipLine_LateUpdate, ZipLine_StaticUpdate,
                 ZipLine_Draw, ZipLine_Create, ZipLine_StageLoad, ZipLine_EditorDraw, ZipLine_EditorLoad, ZipLine_Serialize);
    CreateObject(&Zone, "Zone", sizeof(EntityZone), sizeof(ObjectZone), Zone_Update, Zone_LateUpdate, Zone_StaticUpdate, Zone_Draw, Zone_Create,
