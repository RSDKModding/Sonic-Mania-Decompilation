...
{
    const float3 c5 = float3(0.5, -0.5, 1.5);
    const float4 c8 = float4(-0.333000004, -0.666000009, 0.899999976, 1.20000005);
	...
	r8.x = -1.0;
	r1.zw = (r1 * texSize.xyxy + r8.xxxx).zw;
	r1.zw = (r0.xyxy + r1).zw;
	r4.x = r0.x + r4.y;
	r4 = r4.xzxz + c5.xyxz;
	r4 = r2.xyxy * r4;
	...
	r0.xy = (-r0.yyyy + float4(-1, 1, -2, 2)).xy;
	r0.xy = (r0 * r0).xy;
	r0.xy = (r0 * -8.0).xy;
	...
	r0.w = frac(r0.w);
	r1.xy = (r0.wwww + c8).xy;
	r2.yz = (r1.y >= 0 ? c8.xzww : c8.xwzw).yz;
	r2.x = 0.899999976;
	r1.xyz = (r1.x >= 0 ? r2 : c8.wzzw).xyz;
	r1.xyz = (r0 * r1).xyz;
	r2.z = 720;
	r0.w = r2.z + -viewSize.y;
	
	float4 outColor;
	outColor.rgb = (r0.a >= 0 ? r0 : r1).rgb;
	outColor.a = 1.0;
